...
export function isActivateLeaderboardEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::leaderboard::ActivateLeaderboardEvent`; }
...
export class ActivateLeaderboardEvent implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::leaderboard::ActivateLeaderboardEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ActivateLeaderboardEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::leaderboard::ActivateLeaderboardEvent`; readonly $typeArgs: []; readonly $isPhantom = ActivateLeaderboardEvent.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: ActivateLeaderboardEventFields, ) { this.$fullTypeName = composeSuiType( ActivateLeaderboardEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::leaderboard::ActivateLeaderboardEvent`; this.$typeArgs = typeArgs;

 this.key = fields.key;; this.id = fields.id;; this.log = fields.log;; this.bcsPadding = fields.bcsPadding; }

 static reified( ): ActivateLeaderboardEventReified { return { typeName: ActivateLeaderboardEvent.$typeName, fullTypeName: composeSuiType( ActivateLeaderboardEvent.$typeName, ...[] ) as `${typeof PKG_V1}::leaderboard::ActivateLeaderboardEvent`, typeArgs: [ ] as [], isPhantom: ActivateLeaderboardEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ActivateLeaderboardEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ActivateLeaderboardEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ActivateLeaderboardEvent.fromBcs( data, ), bcs: ActivateLeaderboardEvent.bcs, fromJSONField: (field: any) => ActivateLeaderboardEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ActivateLeaderboardEvent.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ActivateLeaderboardEvent.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => ActivateLeaderboardEvent.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => ActivateLeaderboardEvent.fetch( client, id, ), new: ( fields: ActivateLeaderboardEventFields, ) => { return new ActivateLeaderboardEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): ActivateLeaderboardEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isActivateLeaderboardEvent(data.bcs.type)) { throw new Error(`object at is not a ActivateLeaderboardEvent object`); }

 return ActivateLeaderboardEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return ActivateLeaderboardEvent.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isDeactivateLeaderboardEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::leaderboard::DeactivateLeaderboardEvent`; }
...
export class DeactivateLeaderboardEvent implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::leaderboard::DeactivateLeaderboardEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = DeactivateLeaderboardEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::leaderboard::DeactivateLeaderboardEvent`; readonly $typeArgs: []; readonly $isPhantom = DeactivateLeaderboardEvent.$isPhantom;

 readonly key: ToField<String>; readonly id: ToField<"address">; readonly log: ToField<Vector<"u64">>; readonly bcsPadding: ToField<Vector<Vector<"u8">>>

 private constructor(typeArgs: [], fields: DeactivateLeaderboardEventFields, ) { this.$fullTypeName = composeSuiType( DeactivateLeaderboardEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::leaderboard::DeactivateLeaderboardEvent`; this.$typeArgs = typeArgs;

 this.key = fields.key;; this.id = fields.id;; this.log = fields.log;; this.bcsPadding = fields.bcsPadding; }

 static reified( ): DeactivateLeaderboardEventReified { return { typeName: DeactivateLeaderboardEvent.$typeName, fullTypeName: composeSuiType( DeactivateLeaderboardEvent.$typeName, ...[] ) as `${typeof PKG_V1}::leaderboard::DeactivateLeaderboardEvent`, typeArgs: [ ] as [], isPhantom: DeactivateLeaderboardEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => DeactivateLeaderboardEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DeactivateLeaderboardEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => DeactivateLeaderboardEvent.fromBcs( data, ), bcs: DeactivateLeaderboardEvent.bcs, fromJSONField: (field: any) => DeactivateLeaderboardEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => DeactivateLeaderboardEvent.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => DeactivateLeaderboardEvent.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => DeactivateLeaderboardEvent.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => DeactivateLeaderboardEvent.fetch( client, id, ), new: ( fields: DeactivateLeaderboardEventFields, ) => { return new DeactivateLeaderboardEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): DeactivateLeaderboardEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isDeactivateLeaderboardEvent(data.bcs.type)) { throw new Error(`object at is not a DeactivateLeaderboardEvent object`); }

 return DeactivateLeaderboardEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return DeactivateLeaderboardEvent.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isDeductEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V5}::leaderboard::DeductEvent`; }

export interface DeductEventFields { key: ToField<String>; id: ToField<"address">; user: ToField<"address">; log: ToField<Vector<"u64">>; bcsPadding: ToField<Vector<Vector<"u8">>> }

export type DeductEventReified = Reified< DeductEvent, DeductEventFields >;

export class DeductEvent implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V5}::leaderboard::DeductEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = DeductEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V5}::leaderboard::DeductEvent`; readonly $typeArgs: []; readonly $isPhantom = DeductEvent.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: DeductEventFields, ) { this.$fullTypeName = composeSuiType( DeductEvent.$typeName, ...typeArgs ) as `${typeof PKG_V5}::leaderboard::DeductEvent`; this.$typeArgs = typeArgs;

 this.key = fields.key;; this.id = fields.id;; this.user = fields.user;; this.log = fields.log;; this.bcsPadding = fields.bcsPadding; }

 static reified( ): DeductEventReified { return { typeName: DeductEvent.$typeName, fullTypeName: composeSuiType( DeductEvent.$typeName, ...[] ) as `${typeof PKG_V5}::leaderboard::DeductEvent`, typeArgs: [ ] as [], isPhantom: DeductEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => DeductEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DeductEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => DeductEvent.fromBcs( data, ), bcs: DeductEvent.bcs, fromJSONField: (field: any) => DeductEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => DeductEvent.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => DeductEvent.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => DeductEvent.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => DeductEvent.fetch( client, id, ), new: ( fields: DeductEventFields, ) => { return new DeductEvent( [], fields ) }, kind: "StructClassReified", } }

 static get r() { return DeductEvent.reified() }

 static phantom( ): PhantomReified<ToTypeStr<DeductEvent>> { return phantom(DeductEvent.reified( )); } static get p() { return DeductEvent.phantom() }

 static get bcs() { return bcs.struct("DeductEvent", {
 ...
 static fromFields( fields: Record<string, any> ): DeductEvent { return DeductEvent.reified( ).new( { key: decodeFromFields(String.reified(), fields.key), id: decodeFromFields("address", fields.id), user: decodeFromFields("address", fields.user), log: decodeFromFields(reified.vector("u64"), fields.log), bcsPadding: decodeFromFields(reified.vector(reified.vector("u8")), fields.bcs_padding) } ) }

 static fromFieldsWithTypes( item: FieldsWithTypes ): DeductEvent { if (!isDeductEvent(item.type)) { throw new Error("not a DeductEvent type");

 }

 return DeductEvent.reified( ).new( { key: decodeFromFieldsWithTypes(String.reified(), item.fields.key), id: decodeFromFieldsWithTypes("address", item.fields.id), user: decodeFromFieldsWithTypes("address", item.fields.user), log: decodeFromFieldsWithTypes(reified.vector("u64"), item.fields.log), bcsPadding: decodeFromFieldsWithTypes(reified.vector(reified.vector("u8")), item.fields.bcs_padding) } ) }

 static fromBcs( data: Uint8Array ): DeductEvent { return DeductEvent.fromFields( DeductEvent.bcs.parse(data) ) }
 ...
 static fromJSONField( field: any ): DeductEvent { return DeductEvent.reified( ).new( { key: decodeFromJSONField(String.reified(), field.key), id: decodeFromJSONField("address", field.id), user: decodeFromJSONField("address", field.user), log: decodeFromJSONField(reified.vector("u64"), field.log), bcsPadding: decodeFromJSONField(reified.vector(reified.vector("u8")), field.bcsPadding) } ) }

 static fromJSON( json: Record<string, any> ): DeductEvent { if (json.$typeName !== DeductEvent.$typeName) { throw new Error("not a WithTwoGenerics json object") };

 return DeductEvent.fromJSONField( json, ) }

 static fromSuiParsedData( content: SuiParsedData ): DeductEvent { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isDeductEvent(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a DeductEvent object`); } return DeductEvent.fromFieldsWithTypes( content ); }

 static fromSuiObjectData( data: SuiObjectData ): DeductEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isDeductEvent(data.bcs.type)) { throw new Error(`object at is not a DeductEvent object`); }

 return DeductEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return DeductEvent.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<DeductEvent> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DeductEvent object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDeductEvent(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DeductEvent object`); }
...
export function isExtendLeaderboardEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::leaderboard::ExtendLeaderboardEvent`; }
...
export class ExtendLeaderboardEvent implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::leaderboard::ExtendLeaderboardEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ExtendLeaderboardEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::leaderboard::ExtendLeaderboardEvent`; readonly $typeArgs: []; readonly $isPhantom = ExtendLeaderboardEvent.$isPhantom;

 readonly key: ToField<String>; readonly id: ToField<"address">; readonly log: ToField<Vector<"u64">>; readonly bcsPadding: ToField<Vector<Vector<"u8">>>

 private constructor(typeArgs: [], fields: ExtendLeaderboardEventFields, ) { this.$fullTypeName = composeSuiType( ExtendLeaderboardEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::leaderboard::ExtendLeaderboardEvent`; this.$typeArgs = typeArgs;

 this.key = fields.key;; this.id = fields.id;; this.log = fields.log;; this.bcsPadding = fields.bcsPadding; }

 static reified( ): ExtendLeaderboardEventReified { return { typeName: ExtendLeaderboardEvent.$typeName, fullTypeName: composeSuiType( ExtendLeaderboardEvent.$typeName, ...[] ) as `${typeof PKG_V1}::leaderboard::ExtendLeaderboardEvent`, typeArgs: [ ] as [], isPhantom: ExtendLeaderboardEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ExtendLeaderboardEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ExtendLeaderboardEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ExtendLeaderboardEvent.fromBcs( data, ), bcs: ExtendLeaderboardEvent.bcs, fromJSONField: (field: any) => ExtendLeaderboardEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ExtendLeaderboardEvent.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ExtendLeaderboardEvent.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => ExtendLeaderboardEvent.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => ExtendLeaderboardEvent.fetch( client, id, ), new: ( fields: ExtendLeaderboardEventFields, ) => { return new ExtendLeaderboardEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): ExtendLeaderboardEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isExtendLeaderboardEvent(data.bcs.type)) { throw new Error(`object at is not a ExtendLeaderboardEvent object`); }

 return ExtendLeaderboardEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return ExtendLeaderboardEvent.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isLeaderboard(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::leaderboard::Leaderboard`; }
...
export class Leaderboard implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::leaderboard::Leaderboard`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Leaderboard.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::leaderboard::Leaderboard`; readonly $typeArgs: []; readonly $isPhantom = Leaderboard.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: LeaderboardFields, ) { this.$fullTypeName = composeSuiType( Leaderboard.$typeName, ...typeArgs ) as `${typeof PKG_V1}::leaderboard::Leaderboard`; this.$typeArgs = typeArgs;
 ...
 static reified( ): LeaderboardReified { return { typeName: Leaderboard.$typeName, fullTypeName: composeSuiType( Leaderboard.$typeName, ...[] ) as `${typeof PKG_V1}::leaderboard::Leaderboard`, typeArgs: [ ] as [], isPhantom: Leaderboard.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Leaderboard.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Leaderboard.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Leaderboard.fromBcs( data, ), bcs: Leaderboard.bcs, fromJSONField: (field: any) => Leaderboard.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Leaderboard.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Leaderboard.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Leaderboard.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Leaderboard.fetch( client, id, ), new: ( fields: LeaderboardFields, ) => { return new Leaderboard( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): Leaderboard { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isLeaderboard(data.bcs.type)) { throw new Error(`object at is not a Leaderboard object`); }

 return Leaderboard.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Leaderboard.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isRemoveLeaderboardEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::leaderboard::RemoveLeaderboardEvent`; }
...
export class RemoveLeaderboardEvent implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::leaderboard::RemoveLeaderboardEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = RemoveLeaderboardEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::leaderboard::RemoveLeaderboardEvent`; readonly $typeArgs: []; readonly $isPhantom = RemoveLeaderboardEvent.$isPhantom;

 readonly key: ToField<String>; readonly id: ToField<"address">; readonly log: ToField<Vector<"u64">>; readonly bcsPadding: ToField<Vector<Vector<"u8">>>

 private constructor(typeArgs: [], fields: RemoveLeaderboardEventFields, ) { this.$fullTypeName = composeSuiType( RemoveLeaderboardEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::leaderboard::RemoveLeaderboardEvent`; this.$typeArgs = typeArgs;

 this.key = fields.key;; this.id = fields.id;; this.log = fields.log;; this.bcsPadding = fields.bcsPadding; }

 static reified( ): RemoveLeaderboardEventReified { return { typeName: RemoveLeaderboardEvent.$typeName, fullTypeName: composeSuiType( RemoveLeaderboardEvent.$typeName, ...[] ) as `${typeof PKG_V1}::leaderboard::RemoveLeaderboardEvent`, typeArgs: [ ] as [], isPhantom: RemoveLeaderboardEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => RemoveLeaderboardEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => RemoveLeaderboardEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => RemoveLeaderboardEvent.fromBcs( data, ), bcs: RemoveLeaderboardEvent.bcs, fromJSONField: (field: any) => RemoveLeaderboardEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => RemoveLeaderboardEvent.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => RemoveLeaderboardEvent.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => RemoveLeaderboardEvent.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => RemoveLeaderboardEvent.fetch( client, id, ), new: ( fields: RemoveLeaderboardEventFields, ) => { return new RemoveLeaderboardEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): RemoveLeaderboardEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isRemoveLeaderboardEvent(data.bcs.type)) { throw new Error(`object at is not a RemoveLeaderboardEvent object`); }

 return RemoveLeaderboardEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return RemoveLeaderboardEvent.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isScoreEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::leaderboard::ScoreEvent`; }
...
export class ScoreEvent implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::leaderboard::ScoreEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ScoreEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::leaderboard::ScoreEvent`; readonly $typeArgs: []; readonly $isPhantom = ScoreEvent.$isPhantom;

 readonly key: ToField<String>; readonly id: ToField<"address">; readonly user: ToField<"address">; readonly log: ToField<Vector<"u64">>; readonly bcsPadding: ToField<Vector<Vector<"u8">>>

 private constructor(typeArgs: [], fields: ScoreEventFields, ) { this.$fullTypeName = composeSuiType( ScoreEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::leaderboard::ScoreEvent`; this.$typeArgs = typeArgs;

 this.key = fields.key;; this.id = fields.id;; this.user = fields.user;; this.log = fields.log;; this.bcsPadding = fields.bcsPadding; }

 static reified( ): ScoreEventReified { return { typeName: ScoreEvent.$typeName, fullTypeName: composeSuiType( ScoreEvent.$typeName, ...[] ) as `${typeof PKG_V1}::leaderboard::ScoreEvent`, typeArgs: [ ] as [], isPhantom: ScoreEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ScoreEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ScoreEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ScoreEvent.fromBcs( data, ), bcs: ScoreEvent.bcs, fromJSONField: (field: any) => ScoreEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ScoreEvent.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ScoreEvent.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => ScoreEvent.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => ScoreEvent.fetch( client, id, ), new: ( fields: ScoreEventFields, ) => { return new ScoreEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): ScoreEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isScoreEvent(data.bcs.type)) { throw new Error(`object at is not a ScoreEvent object`); }

 return ScoreEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return ScoreEvent.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isTypusLeaderboardRegistry(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::leaderboard::TypusLeaderboardRegistry`; }
...
export class TypusLeaderboardRegistry implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::leaderboard::TypusLeaderboardRegistry`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = TypusLeaderboardRegistry.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::leaderboard::TypusLeaderboardRegistry`; readonly $typeArgs: []; readonly $isPhantom = TypusLeaderboardRegistry.$isPhantom;

 readonly id: ToField<UID>; readonly activeLeaderboardRegistry: ToField<UID>; readonly inactiveLeaderboardRegistry: ToField<UID>

 private constructor(typeArgs: [], fields: TypusLeaderboardRegistryFields, ) { this.$fullTypeName = composeSuiType( TypusLeaderboardRegistry.$typeName, ...typeArgs ) as `${typeof PKG_V1}::leaderboard::TypusLeaderboardRegistry`; this.$typeArgs = typeArgs;
 ...
 static reified( ): TypusLeaderboardRegistryReified { return { typeName: TypusLeaderboardRegistry.$typeName, fullTypeName: composeSuiType( TypusLeaderboardRegistry.$typeName, ...[] ) as `${typeof PKG_V1}::leaderboard::TypusLeaderboardRegistry`, typeArgs: [ ] as [], isPhantom: TypusLeaderboardRegistry.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => TypusLeaderboardRegistry.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TypusLeaderboardRegistry.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => TypusLeaderboardRegistry.fromBcs( data, ), bcs: TypusLeaderboardRegistry.bcs, fromJSONField: (field: any) => TypusLeaderboardRegistry.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => TypusLeaderboardRegistry.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => TypusLeaderboardRegistry.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => TypusLeaderboardRegistry.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => TypusLeaderboardRegistry.fetch( client, id, ), new: ( fields: TypusLeaderboardRegistryFields, ) => { return new TypusLeaderboardRegistry( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): TypusLeaderboardRegistry { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTypusLeaderboardRegistry(data.bcs.type)) { throw new Error(`object at is not a TypusLeaderboardRegistry object`); }

 return TypusLeaderboardRegistry.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return TypusLeaderboardRegistry.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
