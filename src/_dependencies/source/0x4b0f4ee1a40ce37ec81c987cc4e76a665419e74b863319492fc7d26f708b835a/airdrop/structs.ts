...
export function isAirdrop(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::airdrop::Airdrop`; }
...
export class Airdrop implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::airdrop::Airdrop`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Airdrop.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::airdrop::Airdrop`; readonly $typeArgs: []; readonly $isPhantom = Airdrop.$isPhantom;

 readonly user: ToField<"address">; readonly value: ToField<"u64">

 private constructor(typeArgs: [], fields: AirdropFields, ) { this.$fullTypeName = composeSuiType( Airdrop.$typeName, ...typeArgs ) as `${typeof PKG_V1}::airdrop::Airdrop`; this.$typeArgs = typeArgs;

 this.user = fields.user;; this.value = fields.value; }

 static reified( ): AirdropReified { return { typeName: Airdrop.$typeName, fullTypeName: composeSuiType( Airdrop.$typeName, ...[] ) as `${typeof PKG_V1}::airdrop::Airdrop`, typeArgs: [ ] as [], isPhantom: Airdrop.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Airdrop.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Airdrop.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Airdrop.fromBcs( data, ), bcs: Airdrop.bcs, fromJSONField: (field: any) => Airdrop.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Airdrop.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Airdrop.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Airdrop.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Airdrop.fetch( client, id, ), new: ( fields: AirdropFields, ) => { return new Airdrop( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): Airdrop { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isAirdrop(data.bcs.type)) { throw new Error(`object at is not a Airdrop object`); }

 return Airdrop.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Airdrop.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isAirdropInfo(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V1}::airdrop::AirdropInfo` + '<'); }
...
export class AirdropInfo<TOKEN extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::airdrop::AirdropInfo`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = AirdropInfo.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::airdrop::AirdropInfo<${PhantomToTypeStr<TOKEN>}>`; readonly $typeArgs: [PhantomToTypeStr<TOKEN>]; readonly $isPhantom = AirdropInfo.$isPhantom;

 readonly id: ToField<UID>; readonly balance: ToField<Balance<TOKEN>>; readonly airdrops: ToField<BigVector>

 private constructor(typeArgs: [PhantomToTypeStr<TOKEN>], fields: AirdropInfoFields<TOKEN>, ) { this.$fullTypeName = composeSuiType( AirdropInfo.$typeName, ...typeArgs ) as `${typeof PKG_V1}::airdrop::AirdropInfo<${PhantomToTypeStr<TOKEN>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.balance = fields.balance;; this.airdrops = fields.airdrops; }

 static reified<TOKEN extends PhantomReified<PhantomTypeArgument>>( TOKEN: TOKEN ): AirdropInfoReified<ToPhantomTypeArgument<TOKEN>> { return { typeName: AirdropInfo.$typeName, fullTypeName: composeSuiType( AirdropInfo.$typeName, ...[extractType(TOKEN)] ) as `${typeof PKG_V1}::airdrop::AirdropInfo<${PhantomToTypeStr<ToPhantomTypeArgument<TOKEN>>}>`, typeArgs: [ extractType(TOKEN) ] as [PhantomToTypeStr<ToPhantomTypeArgument<TOKEN>>], isPhantom: AirdropInfo.$isPhantom, reifiedTypeArgs: [TOKEN], fromFields: (fields: Record<string, any>) => AirdropInfo.fromFields( TOKEN, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => AirdropInfo.fromFieldsWithTypes( TOKEN, item, ), fromBcs: (data: Uint8Array) => AirdropInfo.fromBcs( TOKEN, data, ), bcs: AirdropInfo.bcs, fromJSONField: (field: any) => AirdropInfo.fromJSONField( TOKEN, field, ), fromJSON: (json: Record<string, any>) => AirdropInfo.fromJSON( TOKEN, json, ), fromSuiParsedData: (content: SuiParsedData) => AirdropInfo.fromSuiParsedData( TOKEN, content, ), fromSuiObjectData: (content: SuiObjectData) => AirdropInfo.fromSuiObjectData( TOKEN, content, ), fetch: async (client: SuiClient, id: string) => AirdropInfo.fetch( client, TOKEN, id, ), new: ( fields: AirdropInfoFields<ToPhantomTypeArgument<TOKEN>>, ) => { return new AirdropInfo( [extractType(TOKEN)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<TOKEN extends PhantomReified<PhantomTypeArgument>>( typeArg: TOKEN, data: SuiObjectData ): AirdropInfo<ToPhantomTypeArgument<TOKEN>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isAirdropInfo(data.bcs.type)) { throw new Error(`object at is not a AirdropInfo object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

 return AirdropInfo.fromBcs( typeArg, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return AirdropInfo.fromSuiParsedData( typeArg, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isClaimAirdropEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::airdrop::ClaimAirdropEvent`; }
...
export class ClaimAirdropEvent implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::airdrop::ClaimAirdropEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ClaimAirdropEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::airdrop::ClaimAirdropEvent`; readonly $typeArgs: []; readonly $isPhantom = ClaimAirdropEvent.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: ClaimAirdropEventFields, ) { this.$fullTypeName = composeSuiType( ClaimAirdropEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::airdrop::ClaimAirdropEvent`; this.$typeArgs = typeArgs;

 this.token = fields.token;; this.key = fields.key;; this.user = fields.user;; this.log = fields.log;; this.bcsPadding = fields.bcsPadding; }

 static reified( ): ClaimAirdropEventReified { return { typeName: ClaimAirdropEvent.$typeName, fullTypeName: composeSuiType( ClaimAirdropEvent.$typeName, ...[] ) as `${typeof PKG_V1}::airdrop::ClaimAirdropEvent`, typeArgs: [ ] as [], isPhantom: ClaimAirdropEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ClaimAirdropEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ClaimAirdropEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ClaimAirdropEvent.fromBcs( data, ), bcs: ClaimAirdropEvent.bcs, fromJSONField: (field: any) => ClaimAirdropEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ClaimAirdropEvent.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ClaimAirdropEvent.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => ClaimAirdropEvent.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => ClaimAirdropEvent.fetch( client, id, ), new: ( fields: ClaimAirdropEventFields, ) => { return new ClaimAirdropEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): ClaimAirdropEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isClaimAirdropEvent(data.bcs.type)) { throw new Error(`object at is not a ClaimAirdropEvent object`); }

 return ClaimAirdropEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return ClaimAirdropEvent.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isRemoveAirdropEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::airdrop::RemoveAirdropEvent`; }
...
export class RemoveAirdropEvent implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::airdrop::RemoveAirdropEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = RemoveAirdropEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::airdrop::RemoveAirdropEvent`; readonly $typeArgs: []; readonly $isPhantom = RemoveAirdropEvent.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: RemoveAirdropEventFields, ) { this.$fullTypeName = composeSuiType( RemoveAirdropEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::airdrop::RemoveAirdropEvent`; this.$typeArgs = typeArgs;

 this.token = fields.token;; this.key = fields.key;; this.log = fields.log;; this.bcsPadding = fields.bcsPadding; }

 static reified( ): RemoveAirdropEventReified { return { typeName: RemoveAirdropEvent.$typeName, fullTypeName: composeSuiType( RemoveAirdropEvent.$typeName, ...[] ) as `${typeof PKG_V1}::airdrop::RemoveAirdropEvent`, typeArgs: [ ] as [], isPhantom: RemoveAirdropEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => RemoveAirdropEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => RemoveAirdropEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => RemoveAirdropEvent.fromBcs( data, ), bcs: RemoveAirdropEvent.bcs, fromJSONField: (field: any) => RemoveAirdropEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => RemoveAirdropEvent.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => RemoveAirdropEvent.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => RemoveAirdropEvent.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => RemoveAirdropEvent.fetch( client, id, ), new: ( fields: RemoveAirdropEventFields, ) => { return new RemoveAirdropEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): RemoveAirdropEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isRemoveAirdropEvent(data.bcs.type)) { throw new Error(`object at is not a RemoveAirdropEvent object`); }

 return RemoveAirdropEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return RemoveAirdropEvent.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isSetAirdropEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::airdrop::SetAirdropEvent`; }
...
export class SetAirdropEvent implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::airdrop::SetAirdropEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = SetAirdropEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::airdrop::SetAirdropEvent`; readonly $typeArgs: []; readonly $isPhantom = SetAirdropEvent.$isPhantom;

 readonly token: ToField<TypeName>; readonly key: ToField<String>; readonly log: ToField<Vector<"u64">>; readonly bcsPadding: ToField<Vector<Vector<"u8">>>

 private constructor(typeArgs: [], fields: SetAirdropEventFields, ) { this.$fullTypeName = composeSuiType( SetAirdropEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::airdrop::SetAirdropEvent`; this.$typeArgs = typeArgs;

 this.token = fields.token;; this.key = fields.key;; this.log = fields.log;; this.bcsPadding = fields.bcsPadding; }

 static reified( ): SetAirdropEventReified { return { typeName: SetAirdropEvent.$typeName, fullTypeName: composeSuiType( SetAirdropEvent.$typeName, ...[] ) as `${typeof PKG_V1}::airdrop::SetAirdropEvent`, typeArgs: [ ] as [], isPhantom: SetAirdropEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => SetAirdropEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => SetAirdropEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => SetAirdropEvent.fromBcs( data, ), bcs: SetAirdropEvent.bcs, fromJSONField: (field: any) => SetAirdropEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => SetAirdropEvent.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => SetAirdropEvent.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => SetAirdropEvent.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => SetAirdropEvent.fetch( client, id, ), new: ( fields: SetAirdropEventFields, ) => { return new SetAirdropEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): SetAirdropEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isSetAirdropEvent(data.bcs.type)) { throw new Error(`object at is not a SetAirdropEvent object`); }

 return SetAirdropEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return SetAirdropEvent.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isTypusAirdropRegistry(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::airdrop::TypusAirdropRegistry`; }
...
export class TypusAirdropRegistry implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::airdrop::TypusAirdropRegistry`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = TypusAirdropRegistry.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::airdrop::TypusAirdropRegistry`; readonly $typeArgs: []; readonly $isPhantom = TypusAirdropRegistry.$isPhantom;

 readonly id: ToField<UID>

 private constructor(typeArgs: [], fields: TypusAirdropRegistryFields, ) { this.$fullTypeName = composeSuiType( TypusAirdropRegistry.$typeName, ...typeArgs ) as `${typeof PKG_V1}::airdrop::TypusAirdropRegistry`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified( ): TypusAirdropRegistryReified { return { typeName: TypusAirdropRegistry.$typeName, fullTypeName: composeSuiType( TypusAirdropRegistry.$typeName, ...[] ) as `${typeof PKG_V1}::airdrop::TypusAirdropRegistry`, typeArgs: [ ] as [], isPhantom: TypusAirdropRegistry.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => TypusAirdropRegistry.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TypusAirdropRegistry.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => TypusAirdropRegistry.fromBcs( data, ), bcs: TypusAirdropRegistry.bcs, fromJSONField: (field: any) => TypusAirdropRegistry.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => TypusAirdropRegistry.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => TypusAirdropRegistry.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => TypusAirdropRegistry.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => TypusAirdropRegistry.fetch( client, id, ), new: ( fields: TypusAirdropRegistryFields, ) => { return new TypusAirdropRegistry( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): TypusAirdropRegistry { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTypusAirdropRegistry(data.bcs.type)) { throw new Error(`object at is not a TypusAirdropRegistry object`); }

 return TypusAirdropRegistry.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return TypusAirdropRegistry.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
