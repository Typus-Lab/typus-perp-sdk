...
export function isAuction(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::dutch::Auction`; }
...
export class Auction implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::dutch::Auction`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Auction.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::dutch::Auction`; readonly $typeArgs: []; readonly $isPhantom = Auction.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: AuctionFields, ) { this.$fullTypeName = composeSuiType( Auction.$typeName, ...typeArgs ) as `${typeof PKG_V1}::dutch::Auction`; this.$typeArgs = typeArgs;
 ...
 static reified( ): AuctionReified { return { typeName: Auction.$typeName, fullTypeName: composeSuiType( Auction.$typeName, ...[] ) as `${typeof PKG_V1}::dutch::Auction`, typeArgs: [ ] as [], isPhantom: Auction.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Auction.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Auction.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Auction.fromBcs( data, ), bcs: Auction.bcs, fromJSONField: (field: any) => Auction.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Auction.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Auction.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Auction.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Auction.fetch( client, id, ), new: ( fields: AuctionFields, ) => { return new Auction( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): Auction { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isAuction(data.bcs.type)) { throw new Error(`object at is not a Auction object`); }

 return Auction.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Auction.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isBid(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::dutch::Bid`; }
...
export class Bid implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::dutch::Bid`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Bid.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::dutch::Bid`; readonly $typeArgs: []; readonly $isPhantom = Bid.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: BidFields, ) { this.$fullTypeName = composeSuiType( Bid.$typeName, ...typeArgs ) as `${typeof PKG_V1}::dutch::Bid`; this.$typeArgs = typeArgs;
...
export function isDUTCH(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::dutch::DUTCH`; }

export interface DUTCHFields { dummyField: ToField<"bool"> }

export type DUTCHReified = Reified< DUTCH, DUTCHFields >;

export class DUTCH implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::dutch::DUTCH`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = DUTCH.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::dutch::DUTCH`; readonly $typeArgs: []; readonly $isPhantom = DUTCH.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: DUTCHFields, ) { this.$fullTypeName = composeSuiType( DUTCH.$typeName, ...typeArgs ) as `${typeof PKG_V1}::dutch::DUTCH`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): DUTCHReified { return { typeName: DUTCH.$typeName, fullTypeName: composeSuiType( DUTCH.$typeName, ...[] ) as `${typeof PKG_V1}::dutch::DUTCH`, typeArgs: [ ] as [], isPhantom: DUTCH.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => DUTCH.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DUTCH.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => DUTCH.fromBcs( data, ), bcs: DUTCH.bcs, fromJSONField: (field: any) => DUTCH.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => DUTCH.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => DUTCH.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => DUTCH.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => DUTCH.fetch( client, id, ), new: ( fields: DUTCHFields, ) => { return new DUTCH( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): DUTCH { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isDUTCH(data.bcs.type)) { throw new Error(`object at is not a DUTCH object`); }

 return DUTCH.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return DUTCH.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isDelivery(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::dutch::Delivery`; }
...
export class Delivery implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::dutch::Delivery`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Delivery.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::dutch::Delivery`; readonly $typeArgs: []; readonly $isPhantom = Delivery.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: DeliveryFields, ) { this.$fullTypeName = composeSuiType( Delivery.$typeName, ...typeArgs ) as `${typeof PKG_V1}::dutch::Delivery`; this.$typeArgs = typeArgs;
...
export function isNewBid(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::dutch::NewBid`; }
...
export class NewBid implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::dutch::NewBid`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = NewBid.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::dutch::NewBid`; readonly $typeArgs: []; readonly $isPhantom = NewBid.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: NewBidFields, ) { this.$fullTypeName = composeSuiType( NewBid.$typeName, ...typeArgs ) as `${typeof PKG_V1}::dutch::NewBid`; this.$typeArgs = typeArgs;
 ...
 static reified( ): NewBidReified { return { typeName: NewBid.$typeName, fullTypeName: composeSuiType( NewBid.$typeName, ...[] ) as `${typeof PKG_V1}::dutch::NewBid`, typeArgs: [ ] as [], isPhantom: NewBid.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => NewBid.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => NewBid.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => NewBid.fromBcs( data, ), bcs: NewBid.bcs, fromJSONField: (field: any) => NewBid.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => NewBid.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => NewBid.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => NewBid.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => NewBid.fetch( client, id, ), new: ( fields: NewBidFields, ) => { return new NewBid( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): NewBid { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isNewBid(data.bcs.type)) { throw new Error(`object at is not a NewBid object`); }

 return NewBid.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return NewBid.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isRemoveBid(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::dutch::RemoveBid`; }
...
export class RemoveBid implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::dutch::RemoveBid`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = RemoveBid.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::dutch::RemoveBid`; readonly $typeArgs: []; readonly $isPhantom = RemoveBid.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: RemoveBidFields, ) { this.$fullTypeName = composeSuiType( RemoveBid.$typeName, ...typeArgs ) as `${typeof PKG_V1}::dutch::RemoveBid`; this.$typeArgs = typeArgs;
 ...
 static reified( ): RemoveBidReified { return { typeName: RemoveBid.$typeName, fullTypeName: composeSuiType( RemoveBid.$typeName, ...[] ) as `${typeof PKG_V1}::dutch::RemoveBid`, typeArgs: [ ] as [], isPhantom: RemoveBid.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => RemoveBid.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => RemoveBid.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => RemoveBid.fromBcs( data, ), bcs: RemoveBid.bcs, fromJSONField: (field: any) => RemoveBid.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => RemoveBid.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => RemoveBid.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => RemoveBid.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => RemoveBid.fetch( client, id, ), new: ( fields: RemoveBidFields, ) => { return new RemoveBid( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): RemoveBid { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isRemoveBid(data.bcs.type)) { throw new Error(`object at is not a RemoveBid object`); }

 return RemoveBid.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return RemoveBid.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isTerminate(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::dutch::Terminate`; }
...
export function isUpdateAuctionConfig(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::dutch::UpdateAuctionConfig`; }
...
export class UpdateAuctionConfig implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::dutch::UpdateAuctionConfig`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UpdateAuctionConfig.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::dutch::UpdateAuctionConfig`; readonly $typeArgs: []; readonly $isPhantom = UpdateAuctionConfig.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: UpdateAuctionConfigFields, ) { this.$fullTypeName = composeSuiType( UpdateAuctionConfig.$typeName, ...typeArgs ) as `${typeof PKG_V1}::dutch::UpdateAuctionConfig`; this.$typeArgs = typeArgs;
 ...
 static reified( ): UpdateAuctionConfigReified { return { typeName: UpdateAuctionConfig.$typeName, fullTypeName: composeSuiType( UpdateAuctionConfig.$typeName, ...[] ) as `${typeof PKG_V1}::dutch::UpdateAuctionConfig`, typeArgs: [ ] as [], isPhantom: UpdateAuctionConfig.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UpdateAuctionConfig.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UpdateAuctionConfig.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UpdateAuctionConfig.fromBcs( data, ), bcs: UpdateAuctionConfig.bcs, fromJSONField: (field: any) => UpdateAuctionConfig.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UpdateAuctionConfig.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UpdateAuctionConfig.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UpdateAuctionConfig.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UpdateAuctionConfig.fetch( client, id, ), new: ( fields: UpdateAuctionConfigFields, ) => { return new UpdateAuctionConfig( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): UpdateAuctionConfig { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isUpdateAuctionConfig(data.bcs.type)) { throw new Error(`object at is not a UpdateAuctionConfig object`); }

 return UpdateAuctionConfig.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return UpdateAuctionConfig.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
