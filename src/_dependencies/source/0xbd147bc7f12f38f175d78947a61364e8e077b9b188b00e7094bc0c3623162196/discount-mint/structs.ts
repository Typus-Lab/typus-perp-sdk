...
export function isDiscountEventV3(type: string): boolean {
    ...
    return type === `${PKG_V8}::discount_mint::DiscountEventV3`;
}
...
export class DiscountEventV3 implements StructClass {
    ...
    static readonly $typeName = `${PKG_V8}::discount_mint::DiscountEventV3`;
    ...
    private constructor(typeArgs: [], fields: DiscountEventV3Fields) {
        this.$fullTypeName = composeSuiType(DiscountEventV3.$typeName, ...typeArgs) as `${typeof PKG_V8}::discount_mint::DiscountEventV3`;
    ...
    static reified(): DiscountEventV3Reified {
        return {
            ...
            fullTypeName: composeSuiType(DiscountEventV3.$typeName, ...[]) as `${typeof PKG_V8}::discount_mint::DiscountEventV3`,
            typeArgs: [] as [],
...
export function isMintRequest(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V8}::discount_mint::MintRequest`;
}
...
export class MintRequest implements StructClass {
    ...
    static readonly $typeName = `${PKG_V8}::discount_mint::MintRequest`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: MintRequestFields) {
        this.$fullTypeName = composeSuiType(MintRequest.$typeName, ...typeArgs) as `${typeof PKG_V8}::discount_mint::MintRequest`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): MintRequestReified {
        return {
            ...
            fullTypeName: composeSuiType(MintRequest.$typeName, ...[]) as `${typeof PKG_V8}::discount_mint::MintRequest`,
            typeArgs: [] as [],
...
export function isMintRequestEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V8}::discount_mint::MintRequestEvent`;
}
...
export class MintRequestEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V8}::discount_mint::MintRequestEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: MintRequestEventFields) {
        this.$fullTypeName = composeSuiType(MintRequestEvent.$typeName, ...typeArgs) as `${typeof PKG_V8}::discount_mint::MintRequestEvent`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): MintRequestEventReified {
        return {
            ...
            fullTypeName: composeSuiType(MintRequestEvent.$typeName, ...[]) as `${typeof PKG_V8}::discount_mint::MintRequestEvent`,
            typeArgs: [] as [],
...
export function isPool(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V8}::discount_mint::Pool`;
}
...
export class Pool implements StructClass {
    ...
    static readonly $typeName = `${PKG_V8}::discount_mint::Pool`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: PoolFields) {
        this.$fullTypeName = composeSuiType(Pool.$typeName, ...typeArgs) as `${typeof PKG_V8}::discount_mint::Pool`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): PoolReified {
        return {
            ...
            fullTypeName: composeSuiType(Pool.$typeName, ...[]) as `${typeof PKG_V8}::discount_mint::Pool`,
            typeArgs: [] as [],
