...
export function isBalanceInfo(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::balance_pool::BalanceInfo`; }
...
export class BalanceInfo implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::balance_pool::BalanceInfo`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = BalanceInfo.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::balance_pool::BalanceInfo`; readonly $typeArgs: []; readonly $isPhantom = BalanceInfo.$isPhantom;

 readonly token: ToField<TypeName>; readonly value: ToField<"u64">

 private constructor(typeArgs: [], fields: BalanceInfoFields, ) { this.$fullTypeName = composeSuiType( BalanceInfo.$typeName, ...typeArgs ) as `${typeof PKG_V1}::balance_pool::BalanceInfo`; this.$typeArgs = typeArgs;

 this.token = fields.token;; this.value = fields.value; }

 static reified( ): BalanceInfoReified { return { typeName: BalanceInfo.$typeName, fullTypeName: composeSuiType( BalanceInfo.$typeName, ...[] ) as `${typeof PKG_V1}::balance_pool::BalanceInfo`, typeArgs: [ ] as [], isPhantom: BalanceInfo.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => BalanceInfo.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => BalanceInfo.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => BalanceInfo.fromBcs( data, ), bcs: BalanceInfo.bcs, fromJSONField: (field: any) => BalanceInfo.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => BalanceInfo.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => BalanceInfo.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => BalanceInfo.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => BalanceInfo.fetch( client, id, ), new: ( fields: BalanceInfoFields, ) => { return new BalanceInfo( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): BalanceInfo { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBalanceInfo(data.bcs.type)) { throw new Error(`object at is not a BalanceInfo object`); }

 return BalanceInfo.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return BalanceInfo.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isBalancePool(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::balance_pool::BalancePool`; }
...
export class BalancePool implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::balance_pool::BalancePool`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = BalancePool.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::balance_pool::BalancePool`; readonly $typeArgs: []; readonly $isPhantom = BalancePool.$isPhantom;

 readonly id: ToField<UID>; readonly balanceInfos: ToField<Vector<BalanceInfo>>; readonly authority: ToField<Authority>

 private constructor(typeArgs: [], fields: BalancePoolFields, ) { this.$fullTypeName = composeSuiType( BalancePool.$typeName, ...typeArgs ) as `${typeof PKG_V1}::balance_pool::BalancePool`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.balanceInfos = fields.balanceInfos;; this.authority = fields.authority; }

 static reified( ): BalancePoolReified { return { typeName: BalancePool.$typeName, fullTypeName: composeSuiType( BalancePool.$typeName, ...[] ) as `${typeof PKG_V1}::balance_pool::BalancePool`, typeArgs: [ ] as [], isPhantom: BalancePool.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => BalancePool.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => BalancePool.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => BalancePool.fromBcs( data, ), bcs: BalancePool.bcs, fromJSONField: (field: any) => BalancePool.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => BalancePool.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => BalancePool.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => BalancePool.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => BalancePool.fetch( client, id, ), new: ( fields: BalancePoolFields, ) => { return new BalancePool( [], fields ) }, kind: "StructClassReified", } }
 ...
 id: this.id,balanceInfos: fieldToJSON<Vector<BalanceInfo>>(`vector<${BalanceInfo.$typeName}>`, this.balanceInfos),authority: this.authority.toJSONField(),
 ...
 static fromSuiObjectData( data: SuiObjectData ): BalancePool { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBalancePool(data.bcs.type)) { throw new Error(`object at is not a BalancePool object`); }

 return BalancePool.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return BalancePool.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isSharedBalancePool(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::balance_pool::SharedBalancePool`; }
...
export class SharedBalancePool implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::balance_pool::SharedBalancePool`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = SharedBalancePool.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::balance_pool::SharedBalancePool`; readonly $typeArgs: []; readonly $isPhantom = SharedBalancePool.$isPhantom;

 readonly id: ToField<UID>; readonly balanceInfos: ToField<Vector<BalanceInfo>>; readonly authority: ToField<Authority>

 private constructor(typeArgs: [], fields: SharedBalancePoolFields, ) { this.$fullTypeName = composeSuiType( SharedBalancePool.$typeName, ...typeArgs ) as `${typeof PKG_V1}::balance_pool::SharedBalancePool`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.balanceInfos = fields.balanceInfos;; this.authority = fields.authority; }

 static reified( ): SharedBalancePoolReified { return { typeName: SharedBalancePool.$typeName, fullTypeName: composeSuiType( SharedBalancePool.$typeName, ...[] ) as `${typeof PKG_V1}::balance_pool::SharedBalancePool`, typeArgs: [ ] as [], isPhantom: SharedBalancePool.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => SharedBalancePool.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => SharedBalancePool.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => SharedBalancePool.fromBcs( data, ), bcs: SharedBalancePool.bcs, fromJSONField: (field: any) => SharedBalancePool.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => SharedBalancePool.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => SharedBalancePool.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => SharedBalancePool.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => SharedBalancePool.fetch( client, id, ), new: ( fields: SharedBalancePoolFields, ) => { return new SharedBalancePool( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): SharedBalancePool { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isSharedBalancePool(data.bcs.type)) { throw new Error(`object at is not a SharedBalancePool object`); }

 return SharedBalancePool.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return SharedBalancePool.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
