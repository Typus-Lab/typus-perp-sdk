 ...
 * object fields.
 */
export function LinkedObjectTable<K extends BcsType<any>>(...typeParameters: [
    K
]) {
    return new MoveStruct({ name: `${$moduleName}::LinkedObjectTable<${typeParameters[0].name as K['name']}>`, fields: {
