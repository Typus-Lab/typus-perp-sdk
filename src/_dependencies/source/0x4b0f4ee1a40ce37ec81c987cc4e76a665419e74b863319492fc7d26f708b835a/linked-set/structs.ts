...
export function isLinkedSet(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V1}::linked_set::LinkedSet` + '<'); }
...
export class LinkedSet<K extends TypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::linked_set::LinkedSet`; static readonly $numTypeParams = 1; static readonly $isPhantom = [false,] as const;

 readonly $typeName = LinkedSet.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::linked_set::LinkedSet<${ToTypeStr<K>}>`; readonly $typeArgs: [ToTypeStr<K>]; readonly $isPhantom = LinkedSet.$isPhantom;

 readonly id: ToField<UID>; readonly size: ToField<"u64">; readonly head: ToField<Option<K>>; readonly tail: ToField<Option<K>>

 private constructor(typeArgs: [ToTypeStr<K>], fields: LinkedSetFields<K>, ) { this.$fullTypeName = composeSuiType( LinkedSet.$typeName, ...typeArgs ) as `${typeof PKG_V1}::linked_set::LinkedSet<${ToTypeStr<K>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.size = fields.size;; this.head = fields.head;; this.tail = fields.tail; }

 static reified<K extends Reified<TypeArgument, any>>( K: K ): LinkedSetReified<ToTypeArgument<K>> { return { typeName: LinkedSet.$typeName, fullTypeName: composeSuiType( LinkedSet.$typeName, ...[extractType(K)] ) as `${typeof PKG_V1}::linked_set::LinkedSet<${ToTypeStr<ToTypeArgument<K>>}>`, typeArgs: [ extractType(K) ] as [ToTypeStr<ToTypeArgument<K>>], isPhantom: LinkedSet.$isPhantom, reifiedTypeArgs: [K], fromFields: (fields: Record<string, any>) => LinkedSet.fromFields( K, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => LinkedSet.fromFieldsWithTypes( K, item, ), fromBcs: (data: Uint8Array) => LinkedSet.fromBcs( K, data, ), bcs: LinkedSet.bcs(toBcs(K)), fromJSONField: (field: any) => LinkedSet.fromJSONField( K, field, ), fromJSON: (json: Record<string, any>) => LinkedSet.fromJSON( K, json, ), fromSuiParsedData: (content: SuiParsedData) => LinkedSet.fromSuiParsedData( K, content, ), fromSuiObjectData: (content: SuiObjectData) => LinkedSet.fromSuiObjectData( K, content, ), fetch: async (client: SuiClient, id: string) => LinkedSet.fetch( client, K, id, ), new: ( fields: LinkedSetFields<ToTypeArgument<K>>, ) => { return new LinkedSet( [extractType(K)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<K extends Reified<TypeArgument, any>>( typeArg: K, data: SuiObjectData ): LinkedSet<ToTypeArgument<K>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isLinkedSet(data.bcs.type)) { throw new Error(`object at is not a LinkedSet object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

 return LinkedSet.fromBcs( typeArg, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return LinkedSet.fromSuiParsedData( typeArg, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isNode(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V1}::linked_set::Node` + '<'); }
...
export class Node<K extends TypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::linked_set::Node`; static readonly $numTypeParams = 1; static readonly $isPhantom = [false,] as const;

 readonly $typeName = Node.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::linked_set::Node<${ToTypeStr<K>}>`; readonly $typeArgs: [ToTypeStr<K>]; readonly $isPhantom = Node.$isPhantom;

 readonly prev: ToField<Option<K>>; readonly next: ToField<Option<K>>

 private constructor(typeArgs: [ToTypeStr<K>], fields: NodeFields<K>, ) { this.$fullTypeName = composeSuiType( Node.$typeName, ...typeArgs ) as `${typeof PKG_V1}::linked_set::Node<${ToTypeStr<K>}>`; this.$typeArgs = typeArgs;

 this.prev = fields.prev;; this.next = fields.next; }

 static reified<K extends Reified<TypeArgument, any>>( K: K ): NodeReified<ToTypeArgument<K>> { return { typeName: Node.$typeName, fullTypeName: composeSuiType( Node.$typeName, ...[extractType(K)] ) as `${typeof PKG_V1}::linked_set::Node<${ToTypeStr<ToTypeArgument<K>>}>`, typeArgs: [ extractType(K) ] as [ToTypeStr<ToTypeArgument<K>>], isPhantom: Node.$isPhantom, reifiedTypeArgs: [K], fromFields: (fields: Record<string, any>) => Node.fromFields( K, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Node.fromFieldsWithTypes( K, item, ), fromBcs: (data: Uint8Array) => Node.fromBcs( K, data, ), bcs: Node.bcs(toBcs(K)), fromJSONField: (field: any) => Node.fromJSONField( K, field, ), fromJSON: (json: Record<string, any>) => Node.fromJSON( K, json, ), fromSuiParsedData: (content: SuiParsedData) => Node.fromSuiParsedData( K, content, ), fromSuiObjectData: (content: SuiObjectData) => Node.fromSuiObjectData( K, content, ), fetch: async (client: SuiClient, id: string) => Node.fetch( client, K, id, ), new: ( fields: NodeFields<ToTypeArgument<K>>, ) => { return new Node( [extractType(K)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<K extends Reified<TypeArgument, any>>( typeArg: K, data: SuiObjectData ): Node<ToTypeArgument<K>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isNode(data.bcs.type)) { throw new Error(`object at is not a Node object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

 return Node.fromBcs( typeArg, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Node.fromSuiParsedData( typeArg, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
