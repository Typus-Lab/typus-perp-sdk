...
export function isExpUpEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V6}::typus_nft::ExpUpEvent`;
}
...
export class ExpUpEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V6}::typus_nft::ExpUpEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: ExpUpEventFields) {
        this.$fullTypeName = composeSuiType(ExpUpEvent.$typeName, ...typeArgs) as `${typeof PKG_V6}::typus_nft::ExpUpEvent`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): ExpUpEventReified {
        return {
            ...
            fullTypeName: composeSuiType(ExpUpEvent.$typeName, ...[]) as `${typeof PKG_V6}::typus_nft::ExpUpEvent`,
            typeArgs: [] as [],
...
export function isFirstBidEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V6}::typus_nft::FirstBidEvent`;
}
...
export class FirstBidEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V6}::typus_nft::FirstBidEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: FirstBidEventFields) {
        this.$fullTypeName = composeSuiType(FirstBidEvent.$typeName, ...typeArgs) as `${typeof PKG_V6}::typus_nft::FirstBidEvent`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): FirstBidEventReified {
        return {
            ...
            fullTypeName: composeSuiType(FirstBidEvent.$typeName, ...[]) as `${typeof PKG_V6}::typus_nft::FirstBidEvent`,
            typeArgs: [] as [],
...
export function isFirstDepositEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V6}::typus_nft::FirstDepositEvent`;
}
...
export class FirstDepositEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V6}::typus_nft::FirstDepositEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: FirstDepositEventFields) {
        this.$fullTypeName = composeSuiType(FirstDepositEvent.$typeName, ...typeArgs) as `${typeof PKG_V6}::typus_nft::FirstDepositEvent`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): FirstDepositEventReified {
        return {
            ...
            fullTypeName: composeSuiType(FirstDepositEvent.$typeName, ...[]) as `${typeof PKG_V6}::typus_nft::FirstDepositEvent`,
            typeArgs: [] as [],
