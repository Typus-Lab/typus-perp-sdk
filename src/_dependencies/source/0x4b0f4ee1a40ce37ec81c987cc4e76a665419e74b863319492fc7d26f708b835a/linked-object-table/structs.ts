...
export function isLinkedObjectTable(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V1}::linked_object_table::LinkedObjectTable` + '<'); }
...
export class LinkedObjectTable<K extends TypeArgument, V extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::linked_object_table::LinkedObjectTable`; static readonly $numTypeParams = 2; static readonly $isPhantom = [false,true,] as const;

 readonly $typeName = LinkedObjectTable.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::linked_object_table::LinkedObjectTable<${ToTypeStr<K>}, ${PhantomToTypeStr<V>}>`; readonly $typeArgs: [ToTypeStr<K>, PhantomToTypeStr<V>]; readonly $isPhantom = LinkedObjectTable.$isPhantom;
 ...
 private constructor(typeArgs: [ToTypeStr<K>, PhantomToTypeStr<V>], fields: LinkedObjectTableFields<K, V>, ) { this.$fullTypeName = composeSuiType( LinkedObjectTable.$typeName, ...typeArgs ) as `${typeof PKG_V1}::linked_object_table::LinkedObjectTable<${ToTypeStr<K>}, ${PhantomToTypeStr<V>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.vid = fields.vid;; this.size = fields.size;; this.head = fields.head;; this.tail = fields.tail; }

 static reified<K extends Reified<TypeArgument, any>, V extends PhantomReified<PhantomTypeArgument>>( K: K, V: V ): LinkedObjectTableReified<ToTypeArgument<K>, ToPhantomTypeArgument<V>> { return { typeName: LinkedObjectTable.$typeName, fullTypeName: composeSuiType( LinkedObjectTable.$typeName, ...[extractType(K), extractType(V)] ) as `${typeof PKG_V1}::linked_object_table::LinkedObjectTable<${ToTypeStr<ToTypeArgument<K>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<V>>}>`, typeArgs: [ extractType(K), extractType(V) ] as [ToTypeStr<ToTypeArgument<K>>, PhantomToTypeStr<ToPhantomTypeArgument<V>>], isPhantom: LinkedObjectTable.$isPhantom, reifiedTypeArgs: [K, V], fromFields: (fields: Record<string, any>) => LinkedObjectTable.fromFields( [K, V], fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => LinkedObjectTable.fromFieldsWithTypes( [K, V], item, ), fromBcs: (data: Uint8Array) => LinkedObjectTable.fromBcs( [K, V], data, ), bcs: LinkedObjectTable.bcs(toBcs(K)), fromJSONField: (field: any) => LinkedObjectTable.fromJSONField( [K, V], field, ), fromJSON: (json: Record<string, any>) => LinkedObjectTable.fromJSON( [K, V], json, ), fromSuiParsedData: (content: SuiParsedData) => LinkedObjectTable.fromSuiParsedData( [K, V], content, ), fromSuiObjectData: (content: SuiObjectData) => LinkedObjectTable.fromSuiObjectData( [K, V], content, ), fetch: async (client: SuiClient, id: string) => LinkedObjectTable.fetch( client, [K, V], id, ), new: ( fields: LinkedObjectTableFields<ToTypeArgument<K>, ToPhantomTypeArgument<V>>, ) => { return new LinkedObjectTable( [extractType(K), extractType(V)], fields ) }, kind: "StructClassReified", } }
 ...
 id: this.id,vid: this.vid,size: this.size.toString(),head: fieldToJSON<Option<K>>(`${Option.$typeName}<${this.$typeArgs[0]}>`, this.head),tail: fieldToJSON<Option<K>>(`${Option.$typeName}<${this.$typeArgs[0]}>`, this.tail),
 ...
 static fromSuiObjectData<K extends Reified<TypeArgument, any>, V extends PhantomReified<PhantomTypeArgument>>( typeArgs: [K, V], data: SuiObjectData ): LinkedObjectTable<ToTypeArgument<K>, ToPhantomTypeArgument<V>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isLinkedObjectTable(data.bcs.type)) { throw new Error(`object at is not a LinkedObjectTable object`); }
 ...
 return LinkedObjectTable.fromBcs( typeArgs, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return LinkedObjectTable.fromSuiParsedData( typeArgs, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isNode(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V1}::linked_object_table::Node` + '<'); }
...
export class Node<K extends TypeArgument, V extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::linked_object_table::Node`; static readonly $numTypeParams = 2; static readonly $isPhantom = [false,true,] as const;

 readonly $typeName = Node.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::linked_object_table::Node<${ToTypeStr<K>}, ${PhantomToTypeStr<V>}>`; readonly $typeArgs: [ToTypeStr<K>, PhantomToTypeStr<V>]; readonly $isPhantom = Node.$isPhantom;

 readonly prev: ToField<Option<K>>; readonly next: ToField<Option<K>>

 private constructor(typeArgs: [ToTypeStr<K>, PhantomToTypeStr<V>], fields: NodeFields<K, V>, ) { this.$fullTypeName = composeSuiType( Node.$typeName, ...typeArgs ) as `${typeof PKG_V1}::linked_object_table::Node<${ToTypeStr<K>}, ${PhantomToTypeStr<V>}>`; this.$typeArgs = typeArgs;

 this.prev = fields.prev;; this.next = fields.next; }

 static reified<K extends Reified<TypeArgument, any>, V extends PhantomReified<PhantomTypeArgument>>( K: K, V: V ): NodeReified<ToTypeArgument<K>, ToPhantomTypeArgument<V>> { return { typeName: Node.$typeName, fullTypeName: composeSuiType( Node.$typeName, ...[extractType(K), extractType(V)] ) as `${typeof PKG_V1}::linked_object_table::Node<${ToTypeStr<ToTypeArgument<K>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<V>>}>`, typeArgs: [ extractType(K), extractType(V) ] as [ToTypeStr<ToTypeArgument<K>>, PhantomToTypeStr<ToPhantomTypeArgument<V>>], isPhantom: Node.$isPhantom, reifiedTypeArgs: [K, V], fromFields: (fields: Record<string, any>) => Node.fromFields( [K, V], fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Node.fromFieldsWithTypes( [K, V], item, ), fromBcs: (data: Uint8Array) => Node.fromBcs( [K, V], data, ), bcs: Node.bcs(toBcs(K)), fromJSONField: (field: any) => Node.fromJSONField( [K, V], field, ), fromJSON: (json: Record<string, any>) => Node.fromJSON( [K, V], json, ), fromSuiParsedData: (content: SuiParsedData) => Node.fromSuiParsedData( [K, V], content, ), fromSuiObjectData: (content: SuiObjectData) => Node.fromSuiObjectData( [K, V], content, ), fetch: async (client: SuiClient, id: string) => Node.fetch( client, [K, V], id, ), new: ( fields: NodeFields<ToTypeArgument<K>, ToPhantomTypeArgument<V>>, ) => { return new Node( [extractType(K), extractType(V)], fields ) }, kind: "StructClassReified", } }
 ...
 prev: fieldToJSON<Option<K>>(`${Option.$typeName}<${this.$typeArgs[0]}>`, this.prev),next: fieldToJSON<Option<K>>(`${Option.$typeName}<${this.$typeArgs[0]}>`, this.next),
 ...
 static fromSuiObjectData<K extends Reified<TypeArgument, any>, V extends PhantomReified<PhantomTypeArgument>>( typeArgs: [K, V], data: SuiObjectData ): Node<ToTypeArgument<K>, ToPhantomTypeArgument<V>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isNode(data.bcs.type)) { throw new Error(`object at is not a Node object`); }
