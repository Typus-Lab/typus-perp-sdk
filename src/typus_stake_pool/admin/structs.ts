...
export class FeePool implements StructClass {
    ...
    static reified(): FeePoolReified {
        ...
        return {
            ...
            fromBcs: (data: Uint8Array) => FeePool.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof FeePool.instantiateBcs> | null = null;
...
export class FeeInfo implements StructClass {
    ...
    static reified(): FeeInfoReified {
        ...
        return {
            ...
            fromBcs: (data: Uint8Array) => FeeInfo.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof FeeInfo.instantiateBcs> | null = null;
...
export class SendFeeEvent implements StructClass {
    ...
    static reified(): SendFeeEventReified {
        const reifiedBcs = SendFeeEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => SendFeeEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof SendFeeEvent.instantiateBcs> | null = null;
