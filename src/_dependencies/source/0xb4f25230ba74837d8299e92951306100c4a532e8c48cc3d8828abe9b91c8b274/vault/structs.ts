...
export function isActivate(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::Activate`; }
...
export class Activate implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::Activate`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Activate.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::Activate`; readonly $typeArgs: []; readonly $isPhantom = Activate.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: ActivateFields, ) { this.$fullTypeName = composeSuiType( Activate.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::Activate`; this.$typeArgs = typeArgs;
 ...
 static reified( ): ActivateReified { return { typeName: Activate.$typeName, fullTypeName: composeSuiType( Activate.$typeName, ...[] ) as `${typeof PKG_V1}::vault::Activate`, typeArgs: [ ] as [], isPhantom: Activate.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Activate.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Activate.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Activate.fromBcs( data, ), bcs: Activate.bcs, fromJSONField: (field: any) => Activate.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Activate.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Activate.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Activate.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Activate.fetch( client, id, ), new: ( fields: ActivateFields, ) => { return new Activate( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): Activate { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isActivate(data.bcs.type)) { throw new Error(`object at is not a Activate object`); }

 return Activate.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Activate.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isBidShare(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::BidShare`; }
...
export class BidShare implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::BidShare`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = BidShare.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::BidShare`; readonly $typeArgs: []; readonly $isPhantom = BidShare.$isPhantom;

 readonly receipt: ToField<"address">; readonly share: ToField<"u64">; readonly u64Padding: ToField<Vector<"u64">>

 private constructor(typeArgs: [], fields: BidShareFields, ) { this.$fullTypeName = composeSuiType( BidShare.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::BidShare`; this.$typeArgs = typeArgs;

 this.receipt = fields.receipt;; this.share = fields.share;; this.u64Padding = fields.u64Padding; }

 static reified( ): BidShareReified { return { typeName: BidShare.$typeName, fullTypeName: composeSuiType( BidShare.$typeName, ...[] ) as `${typeof PKG_V1}::vault::BidShare`, typeArgs: [ ] as [], isPhantom: BidShare.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => BidShare.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => BidShare.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => BidShare.fromBcs( data, ), bcs: BidShare.bcs, fromJSONField: (field: any) => BidShare.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => BidShare.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => BidShare.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => BidShare.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => BidShare.fetch( client, id, ), new: ( fields: BidShareFields, ) => { return new BidShare( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): BidShare { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBidShare(data.bcs.type)) { throw new Error(`object at is not a BidShare object`); }

 return BidShare.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return BidShare.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isBidVault(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::BidVault`; }
...
export class BidVault implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::BidVault`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = BidVault.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::BidVault`; readonly $typeArgs: []; readonly $isPhantom = BidVault.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: BidVaultFields, ) { this.$fullTypeName = composeSuiType( BidVault.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::BidVault`; this.$typeArgs = typeArgs;
 ...
 static reified( ): BidVaultReified { return { typeName: BidVault.$typeName, fullTypeName: composeSuiType( BidVault.$typeName, ...[] ) as `${typeof PKG_V1}::vault::BidVault`, typeArgs: [ ] as [], isPhantom: BidVault.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => BidVault.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => BidVault.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => BidVault.fromBcs( data, ), bcs: BidVault.bcs, fromJSONField: (field: any) => BidVault.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => BidVault.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => BidVault.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => BidVault.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => BidVault.fetch( client, id, ), new: ( fields: BidVaultFields, ) => { return new BidVault( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): BidVault { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBidVault(data.bcs.type)) { throw new Error(`object at is not a BidVault object`); }

 return BidVault.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return BidVault.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isClaim(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::Claim`; }
...
export class Claim implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::vault::Claim`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Claim.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::Claim`; readonly $typeArgs: []; readonly $isPhantom = Claim.$isPhantom;

 readonly signer: ToField<"address">; readonly index: ToField<"u64">; readonly token: ToField<TypeName>; readonly amount: ToField<"u64">

 private constructor(typeArgs: [], fields: ClaimFields, ) { this.$fullTypeName = composeSuiType( Claim.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::Claim`; this.$typeArgs = typeArgs;

 this.signer = fields.signer;; this.index = fields.index;; this.token = fields.token;; this.amount = fields.amount; }

 static reified( ): ClaimReified { return { typeName: Claim.$typeName, fullTypeName: composeSuiType( Claim.$typeName, ...[] ) as `${typeof PKG_V1}::vault::Claim`, typeArgs: [ ] as [], isPhantom: Claim.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Claim.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Claim.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Claim.fromBcs( data, ), bcs: Claim.bcs, fromJSONField: (field: any) => Claim.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Claim.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Claim.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Claim.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Claim.fetch( client, id, ), new: ( fields: ClaimFields, ) => { return new Claim( [], fields ) }, kind: "StructClassReified", } }
...
export function isCompound(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::Compound`; }
...
export class Compound implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::Compound`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Compound.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::Compound`; readonly $typeArgs: []; readonly $isPhantom = Compound.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: CompoundFields, ) { this.$fullTypeName = composeSuiType( Compound.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::Compound`; this.$typeArgs = typeArgs;
 ...
 static reified( ): CompoundReified { return { typeName: Compound.$typeName, fullTypeName: composeSuiType( Compound.$typeName, ...[] ) as `${typeof PKG_V1}::vault::Compound`, typeArgs: [ ] as [], isPhantom: Compound.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Compound.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Compound.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Compound.fromBcs( data, ), bcs: Compound.bcs, fromJSONField: (field: any) => Compound.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Compound.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Compound.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Compound.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Compound.fetch( client, id, ), new: ( fields: CompoundFields, ) => { return new Compound( [], fields ) }, kind: "StructClassReified", } }
 ...
 signer: this.signer,index: this.index.toString(),token: this.token.toJSONField(),amount: this.amount.toString(),feeAmount: this.feeAmount.toString(),feeShareAmount: this.feeShareAmount.toString(),sharedFeePool: fieldToJSON<Option<Vector<"u8">>>(`${Option.$typeName}<vector<u8>>`, this.sharedFeePool),
 ...
 static fromSuiObjectData( data: SuiObjectData ): Compound { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isCompound(data.bcs.type)) { throw new Error(`object at is not a Compound object`); }

 return Compound.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Compound.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isDelivery(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::Delivery`; }
...
export class Delivery implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::Delivery`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Delivery.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::Delivery`; readonly $typeArgs: []; readonly $isPhantom = Delivery.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: DeliveryFields, ) { this.$fullTypeName = composeSuiType( Delivery.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::Delivery`; this.$typeArgs = typeArgs;
 ...
 static reified( ): DeliveryReified { return { typeName: Delivery.$typeName, fullTypeName: composeSuiType( Delivery.$typeName, ...[] ) as `${typeof PKG_V1}::vault::Delivery`, typeArgs: [ ] as [], isPhantom: Delivery.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Delivery.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Delivery.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Delivery.fromBcs( data, ), bcs: Delivery.bcs, fromJSONField: (field: any) => Delivery.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Delivery.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Delivery.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Delivery.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Delivery.fetch( client, id, ), new: ( fields: DeliveryFields, ) => { return new Delivery( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): Delivery { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isDelivery(data.bcs.type)) { throw new Error(`object at is not a Delivery object`); }

 return Delivery.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Delivery.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isDeposit(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::Deposit`; }
...
export class Deposit implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::vault::Deposit`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Deposit.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::Deposit`; readonly $typeArgs: []; readonly $isPhantom = Deposit.$isPhantom;

 readonly signer: ToField<"address">; readonly index: ToField<"u64">; readonly token: ToField<TypeName>; readonly amount: ToField<"u64">

 private constructor(typeArgs: [], fields: DepositFields, ) { this.$fullTypeName = composeSuiType( Deposit.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::Deposit`; this.$typeArgs = typeArgs;

 this.signer = fields.signer;; this.index = fields.index;; this.token = fields.token;; this.amount = fields.amount; }

 static reified( ): DepositReified { return { typeName: Deposit.$typeName, fullTypeName: composeSuiType( Deposit.$typeName, ...[] ) as `${typeof PKG_V1}::vault::Deposit`, typeArgs: [ ] as [], isPhantom: Deposit.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Deposit.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Deposit.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Deposit.fromBcs( data, ), bcs: Deposit.bcs, fromJSONField: (field: any) => Deposit.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Deposit.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Deposit.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Deposit.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Deposit.fetch( client, id, ), new: ( fields: DepositFields, ) => { return new Deposit( [], fields ) }, kind: "StructClassReified", } }
...
export function isDepositShare(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::DepositShare`; }
...
export class DepositShare implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::DepositShare`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = DepositShare.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::DepositShare`; readonly $typeArgs: []; readonly $isPhantom = DepositShare.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: DepositShareFields, ) { this.$fullTypeName = composeSuiType( DepositShare.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::DepositShare`; this.$typeArgs = typeArgs;
 ...
 static reified( ): DepositShareReified { return { typeName: DepositShare.$typeName, fullTypeName: composeSuiType( DepositShare.$typeName, ...[] ) as `${typeof PKG_V1}::vault::DepositShare`, typeArgs: [ ] as [], isPhantom: DepositShare.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => DepositShare.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DepositShare.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => DepositShare.fromBcs( data, ), bcs: DepositShare.bcs, fromJSONField: (field: any) => DepositShare.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => DepositShare.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => DepositShare.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => DepositShare.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => DepositShare.fetch( client, id, ), new: ( fields: DepositShareFields, ) => { return new DepositShare( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): DepositShare { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isDepositShare(data.bcs.type)) { throw new Error(`object at is not a DepositShare object`); }

 return DepositShare.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return DepositShare.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isDepositVault(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::DepositVault`; }
...
export class DepositVault implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::DepositVault`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = DepositVault.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::DepositVault`; readonly $typeArgs: []; readonly $isPhantom = DepositVault.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: DepositVaultFields, ) { this.$fullTypeName = composeSuiType( DepositVault.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::DepositVault`; this.$typeArgs = typeArgs;
 ...
 static reified( ): DepositVaultReified { return { typeName: DepositVault.$typeName, fullTypeName: composeSuiType( DepositVault.$typeName, ...[] ) as `${typeof PKG_V1}::vault::DepositVault`, typeArgs: [ ] as [], isPhantom: DepositVault.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => DepositVault.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DepositVault.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => DepositVault.fromBcs( data, ), bcs: DepositVault.bcs, fromJSONField: (field: any) => DepositVault.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => DepositVault.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => DepositVault.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => DepositVault.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => DepositVault.fetch( client, id, ), new: ( fields: DepositVaultFields, ) => { return new DepositVault( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): DepositVault { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isDepositVault(data.bcs.type)) { throw new Error(`object at is not a DepositVault object`); }

 return DepositVault.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return DepositVault.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isExercise(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::Exercise`; }
...
export class Exercise implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::Exercise`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Exercise.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::Exercise`; readonly $typeArgs: []; readonly $isPhantom = Exercise.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: ExerciseFields, ) { this.$fullTypeName = composeSuiType( Exercise.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::Exercise`; this.$typeArgs = typeArgs;
 ...
 static reified( ): ExerciseReified { return { typeName: Exercise.$typeName, fullTypeName: composeSuiType( Exercise.$typeName, ...[] ) as `${typeof PKG_V1}::vault::Exercise`, typeArgs: [ ] as [], isPhantom: Exercise.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Exercise.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Exercise.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Exercise.fromBcs( data, ), bcs: Exercise.bcs, fromJSONField: (field: any) => Exercise.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Exercise.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Exercise.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Exercise.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Exercise.fetch( client, id, ), new: ( fields: ExerciseFields, ) => { return new Exercise( [], fields ) }, kind: "StructClassReified", } }
 ...
 signer: this.signer,index: this.index.toString(),depositToken: this.depositToken.toJSONField(),incentiveToken: fieldToJSON<Option<TypeName>>(`${Option.$typeName}<${TypeName.$typeName}>`, this.incentiveToken),amount: this.amount.toString(),
 ...
 static fromSuiObjectData( data: SuiObjectData ): Exercise { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isExercise(data.bcs.type)) { throw new Error(`object at is not a Exercise object`); }

 return Exercise.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Exercise.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isHarvest(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::Harvest`; }
...
export class Harvest implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::Harvest`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Harvest.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::Harvest`; readonly $typeArgs: []; readonly $isPhantom = Harvest.$isPhantom;

 readonly signer: ToField<"address">; readonly index: ToField<"u64">; readonly token: ToField<TypeName>; readonly amount: ToField<"u64">; readonly feeAmount: ToField<"u64">; readonly feeShareAmount: ToField<"u64">; readonly sharedFeePool: ToField<Option<Vector<"u8">>>

 private constructor(typeArgs: [], fields: HarvestFields, ) { this.$fullTypeName = composeSuiType( Harvest.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::Harvest`; this.$typeArgs = typeArgs;

 this.signer = fields.signer;; this.index = fields.index;; this.token = fields.token;; this.amount = fields.amount;; this.feeAmount = fields.feeAmount;; this.feeShareAmount = fields.feeShareAmount;; this.sharedFeePool = fields.sharedFeePool; }

 static reified( ): HarvestReified { return { typeName: Harvest.$typeName, fullTypeName: composeSuiType( Harvest.$typeName, ...[] ) as `${typeof PKG_V1}::vault::Harvest`, typeArgs: [ ] as [], isPhantom: Harvest.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Harvest.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Harvest.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Harvest.fromBcs( data, ), bcs: Harvest.bcs, fromJSONField: (field: any) => Harvest.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Harvest.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Harvest.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Harvest.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Harvest.fetch( client, id, ), new: ( fields: HarvestFields, ) => { return new Harvest( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): Harvest { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isHarvest(data.bcs.type)) { throw new Error(`object at is not a Harvest object`); }

 return Harvest.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Harvest.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isIncentiviseBidder(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::IncentiviseBidder`; }
...
export class IncentiviseBidder implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::IncentiviseBidder`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = IncentiviseBidder.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::IncentiviseBidder`; readonly $typeArgs: []; readonly $isPhantom = IncentiviseBidder.$isPhantom;

 readonly signer: ToField<"address">; readonly index: ToField<"u64">; readonly token: ToField<TypeName>; readonly amount: ToField<"u64">

 private constructor(typeArgs: [], fields: IncentiviseBidderFields, ) { this.$fullTypeName = composeSuiType( IncentiviseBidder.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::IncentiviseBidder`; this.$typeArgs = typeArgs;

 this.signer = fields.signer;; this.index = fields.index;; this.token = fields.token;; this.amount = fields.amount; }

 static reified( ): IncentiviseBidderReified { return { typeName: IncentiviseBidder.$typeName, fullTypeName: composeSuiType( IncentiviseBidder.$typeName, ...[] ) as `${typeof PKG_V1}::vault::IncentiviseBidder`, typeArgs: [ ] as [], isPhantom: IncentiviseBidder.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => IncentiviseBidder.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => IncentiviseBidder.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => IncentiviseBidder.fromBcs( data, ), bcs: IncentiviseBidder.bcs, fromJSONField: (field: any) => IncentiviseBidder.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => IncentiviseBidder.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => IncentiviseBidder.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => IncentiviseBidder.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => IncentiviseBidder.fetch( client, id, ), new: ( fields: IncentiviseBidderFields, ) => { return new IncentiviseBidder( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): IncentiviseBidder { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isIncentiviseBidder(data.bcs.type)) { throw new Error(`object at is not a IncentiviseBidder object`); }

 return IncentiviseBidder.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return IncentiviseBidder.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isNewBidVault(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::NewBidVault`; }
...
export class NewBidVault implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::NewBidVault`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = NewBidVault.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::NewBidVault`; readonly $typeArgs: []; readonly $isPhantom = NewBidVault.$isPhantom;

 readonly signer: ToField<"address">; readonly index: ToField<"u64">; readonly bidToken: ToField<TypeName>

 private constructor(typeArgs: [], fields: NewBidVaultFields, ) { this.$fullTypeName = composeSuiType( NewBidVault.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::NewBidVault`; this.$typeArgs = typeArgs;

 this.signer = fields.signer;; this.index = fields.index;; this.bidToken = fields.bidToken; }

 static reified( ): NewBidVaultReified { return { typeName: NewBidVault.$typeName, fullTypeName: composeSuiType( NewBidVault.$typeName, ...[] ) as `${typeof PKG_V1}::vault::NewBidVault`, typeArgs: [ ] as [], isPhantom: NewBidVault.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => NewBidVault.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => NewBidVault.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => NewBidVault.fromBcs( data, ), bcs: NewBidVault.bcs, fromJSONField: (field: any) => NewBidVault.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => NewBidVault.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => NewBidVault.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => NewBidVault.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => NewBidVault.fetch( client, id, ), new: ( fields: NewBidVaultFields, ) => { return new NewBidVault( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): NewBidVault { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isNewBidVault(data.bcs.type)) { throw new Error(`object at is not a NewBidVault object`); }

 return NewBidVault.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return NewBidVault.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isNewDepositVault(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::NewDepositVault`; }
...
export class NewDepositVault implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::NewDepositVault`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = NewDepositVault.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::NewDepositVault`; readonly $typeArgs: []; readonly $isPhantom = NewDepositVault.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: NewDepositVaultFields, ) { this.$fullTypeName = composeSuiType( NewDepositVault.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::NewDepositVault`; this.$typeArgs = typeArgs;

 this.signer = fields.signer;; this.index = fields.index;; this.depositToken = fields.depositToken;; this.bidToken = fields.bidToken; }

 static reified( ): NewDepositVaultReified { return { typeName: NewDepositVault.$typeName, fullTypeName: composeSuiType( NewDepositVault.$typeName, ...[] ) as `${typeof PKG_V1}::vault::NewDepositVault`, typeArgs: [ ] as [], isPhantom: NewDepositVault.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => NewDepositVault.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => NewDepositVault.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => NewDepositVault.fromBcs( data, ), bcs: NewDepositVault.bcs, fromJSONField: (field: any) => NewDepositVault.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => NewDepositVault.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => NewDepositVault.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => NewDepositVault.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => NewDepositVault.fetch( client, id, ), new: ( fields: NewDepositVaultFields, ) => { return new NewDepositVault( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): NewDepositVault { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isNewDepositVault(data.bcs.type)) { throw new Error(`object at is not a NewDepositVault object`); }

 return NewDepositVault.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return NewDepositVault.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isNewRefundVault(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::NewRefundVault`; }
...
export class NewRefundVault implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::NewRefundVault`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = NewRefundVault.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::NewRefundVault`; readonly $typeArgs: []; readonly $isPhantom = NewRefundVault.$isPhantom;

 readonly signer: ToField<"address">; readonly token: ToField<TypeName>

 private constructor(typeArgs: [], fields: NewRefundVaultFields, ) { this.$fullTypeName = composeSuiType( NewRefundVault.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::NewRefundVault`; this.$typeArgs = typeArgs;

 this.signer = fields.signer;; this.token = fields.token; }

 static reified( ): NewRefundVaultReified { return { typeName: NewRefundVault.$typeName, fullTypeName: composeSuiType( NewRefundVault.$typeName, ...[] ) as `${typeof PKG_V1}::vault::NewRefundVault`, typeArgs: [ ] as [], isPhantom: NewRefundVault.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => NewRefundVault.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => NewRefundVault.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => NewRefundVault.fromBcs( data, ), bcs: NewRefundVault.bcs, fromJSONField: (field: any) => NewRefundVault.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => NewRefundVault.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => NewRefundVault.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => NewRefundVault.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => NewRefundVault.fetch( client, id, ), new: ( fields: NewRefundVaultFields, ) => { return new NewRefundVault( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): NewRefundVault { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isNewRefundVault(data.bcs.type)) { throw new Error(`object at is not a NewRefundVault object`); }

 return NewRefundVault.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return NewRefundVault.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isRecoup(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::Recoup`; }
...
export class Recoup implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::Recoup`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Recoup.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::Recoup`; readonly $typeArgs: []; readonly $isPhantom = Recoup.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: RecoupFields, ) { this.$fullTypeName = composeSuiType( Recoup.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::Recoup`; this.$typeArgs = typeArgs;
 ...
 static reified( ): RecoupReified { return { typeName: Recoup.$typeName, fullTypeName: composeSuiType( Recoup.$typeName, ...[] ) as `${typeof PKG_V1}::vault::Recoup`, typeArgs: [ ] as [], isPhantom: Recoup.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Recoup.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Recoup.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Recoup.fromBcs( data, ), bcs: Recoup.bcs, fromJSONField: (field: any) => Recoup.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Recoup.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Recoup.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Recoup.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Recoup.fetch( client, id, ), new: ( fields: RecoupFields, ) => { return new Recoup( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): Recoup { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isRecoup(data.bcs.type)) { throw new Error(`object at is not a Recoup object`); }

 return Recoup.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Recoup.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isRedeem(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::Redeem`; }
...
export class Redeem implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::vault::Redeem`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Redeem.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::Redeem`; readonly $typeArgs: []; readonly $isPhantom = Redeem.$isPhantom;

 readonly signer: ToField<"address">; readonly index: ToField<"u64">; readonly token: ToField<TypeName>; readonly amount: ToField<"u64">

 private constructor(typeArgs: [], fields: RedeemFields, ) { this.$fullTypeName = composeSuiType( Redeem.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::Redeem`; this.$typeArgs = typeArgs;

 this.signer = fields.signer;; this.index = fields.index;; this.token = fields.token;; this.amount = fields.amount; }

 static reified( ): RedeemReified { return { typeName: Redeem.$typeName, fullTypeName: composeSuiType( Redeem.$typeName, ...[] ) as `${typeof PKG_V1}::vault::Redeem`, typeArgs: [ ] as [], isPhantom: Redeem.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Redeem.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Redeem.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Redeem.fromBcs( data, ), bcs: Redeem.bcs, fromJSONField: (field: any) => Redeem.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Redeem.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Redeem.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Redeem.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Redeem.fetch( client, id, ), new: ( fields: RedeemFields, ) => { return new Redeem( [], fields ) }, kind: "StructClassReified", } }
...
export function isRefundShare(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::RefundShare`; }
...
export class RefundShare implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::RefundShare`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = RefundShare.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::RefundShare`; readonly $typeArgs: []; readonly $isPhantom = RefundShare.$isPhantom;

 readonly user: ToField<"address">; readonly share: ToField<"u64">; readonly u64Padding: ToField<Vector<"u64">>

 private constructor(typeArgs: [], fields: RefundShareFields, ) { this.$fullTypeName = composeSuiType( RefundShare.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::RefundShare`; this.$typeArgs = typeArgs;

 this.user = fields.user;; this.share = fields.share;; this.u64Padding = fields.u64Padding; }

 static reified( ): RefundShareReified { return { typeName: RefundShare.$typeName, fullTypeName: composeSuiType( RefundShare.$typeName, ...[] ) as `${typeof PKG_V1}::vault::RefundShare`, typeArgs: [ ] as [], isPhantom: RefundShare.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => RefundShare.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => RefundShare.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => RefundShare.fromBcs( data, ), bcs: RefundShare.bcs, fromJSONField: (field: any) => RefundShare.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => RefundShare.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => RefundShare.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => RefundShare.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => RefundShare.fetch( client, id, ), new: ( fields: RefundShareFields, ) => { return new RefundShare( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): RefundShare { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isRefundShare(data.bcs.type)) { throw new Error(`object at is not a RefundShare object`); }

 return RefundShare.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return RefundShare.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isRefundVault(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::RefundVault`; }
...
export class RefundVault implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::RefundVault`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = RefundVault.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::RefundVault`; readonly $typeArgs: []; readonly $isPhantom = RefundVault.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: RefundVaultFields, ) { this.$fullTypeName = composeSuiType( RefundVault.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::RefundVault`; this.$typeArgs = typeArgs;
 ...
 static reified( ): RefundVaultReified { return { typeName: RefundVault.$typeName, fullTypeName: composeSuiType( RefundVault.$typeName, ...[] ) as `${typeof PKG_V1}::vault::RefundVault`, typeArgs: [ ] as [], isPhantom: RefundVault.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => RefundVault.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => RefundVault.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => RefundVault.fromBcs( data, ), bcs: RefundVault.bcs, fromJSONField: (field: any) => RefundVault.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => RefundVault.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => RefundVault.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => RefundVault.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => RefundVault.fetch( client, id, ), new: ( fields: RefundVaultFields, ) => { return new RefundVault( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): RefundVault { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isRefundVault(data.bcs.type)) { throw new Error(`object at is not a RefundVault object`); }

 return RefundVault.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return RefundVault.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isSettle(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::Settle`; }
...
export class Settle implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::Settle`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Settle.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::Settle`; readonly $typeArgs: []; readonly $isPhantom = Settle.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: SettleFields, ) { this.$fullTypeName = composeSuiType( Settle.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::Settle`; this.$typeArgs = typeArgs;
 ...
 static reified( ): SettleReified { return { typeName: Settle.$typeName, fullTypeName: composeSuiType( Settle.$typeName, ...[] ) as `${typeof PKG_V1}::vault::Settle`, typeArgs: [ ] as [], isPhantom: Settle.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Settle.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Settle.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Settle.fromBcs( data, ), bcs: Settle.bcs, fromJSONField: (field: any) => Settle.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Settle.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Settle.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Settle.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Settle.fetch( client, id, ), new: ( fields: SettleFields, ) => { return new Settle( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): Settle { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isSettle(data.bcs.type)) { throw new Error(`object at is not a Settle object`); }

 return Settle.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Settle.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isTerminate(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::Terminate`; }
...
export class Terminate implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::Terminate`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Terminate.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::Terminate`; readonly $typeArgs: []; readonly $isPhantom = Terminate.$isPhantom;

 readonly signer: ToField<"address">; readonly index: ToField<"u64">; readonly token: ToField<TypeName>

 private constructor(typeArgs: [], fields: TerminateFields, ) { this.$fullTypeName = composeSuiType( Terminate.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::Terminate`; this.$typeArgs = typeArgs;

 this.signer = fields.signer;; this.index = fields.index;; this.token = fields.token; }

 static reified( ): TerminateReified { return { typeName: Terminate.$typeName, fullTypeName: composeSuiType( Terminate.$typeName, ...[] ) as `${typeof PKG_V1}::vault::Terminate`, typeArgs: [ ] as [], isPhantom: Terminate.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Terminate.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Terminate.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Terminate.fromBcs( data, ), bcs: Terminate.bcs, fromJSONField: (field: any) => Terminate.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Terminate.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Terminate.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Terminate.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Terminate.fetch( client, id, ), new: ( fields: TerminateFields, ) => { return new Terminate( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): Terminate { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTerminate(data.bcs.type)) { throw new Error(`object at is not a Terminate object`); }

 return Terminate.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Terminate.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isTypusBidReceipt(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::TypusBidReceipt`; }
...
export class TypusBidReceipt implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::TypusBidReceipt`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = TypusBidReceipt.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::TypusBidReceipt`; readonly $typeArgs: []; readonly $isPhantom = TypusBidReceipt.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: TypusBidReceiptFields, ) { this.$fullTypeName = composeSuiType( TypusBidReceipt.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::TypusBidReceipt`; this.$typeArgs = typeArgs;
 ...
 static reified( ): TypusBidReceiptReified { return { typeName: TypusBidReceipt.$typeName, fullTypeName: composeSuiType( TypusBidReceipt.$typeName, ...[] ) as `${typeof PKG_V1}::vault::TypusBidReceipt`, typeArgs: [ ] as [], isPhantom: TypusBidReceipt.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => TypusBidReceipt.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TypusBidReceipt.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => TypusBidReceipt.fromBcs( data, ), bcs: TypusBidReceipt.bcs, fromJSONField: (field: any) => TypusBidReceipt.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => TypusBidReceipt.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => TypusBidReceipt.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => TypusBidReceipt.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => TypusBidReceipt.fetch( client, id, ), new: ( fields: TypusBidReceiptFields, ) => { return new TypusBidReceipt( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): TypusBidReceipt { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTypusBidReceipt(data.bcs.type)) { throw new Error(`object at is not a TypusBidReceipt object`); }

 return TypusBidReceipt.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return TypusBidReceipt.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isTypusDepositReceipt(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::TypusDepositReceipt`; }
...
export class TypusDepositReceipt implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::TypusDepositReceipt`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = TypusDepositReceipt.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::TypusDepositReceipt`; readonly $typeArgs: []; readonly $isPhantom = TypusDepositReceipt.$isPhantom;

 readonly id: ToField<UID>; readonly vid: ToField<ID>; readonly index: ToField<"u64">; readonly metadata: ToField<String>; readonly u64Padding: ToField<Vector<"u64">>

 private constructor(typeArgs: [], fields: TypusDepositReceiptFields, ) { this.$fullTypeName = composeSuiType( TypusDepositReceipt.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::TypusDepositReceipt`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.vid = fields.vid;; this.index = fields.index;; this.metadata = fields.metadata;; this.u64Padding = fields.u64Padding; }

 static reified( ): TypusDepositReceiptReified { return { typeName: TypusDepositReceipt.$typeName, fullTypeName: composeSuiType( TypusDepositReceipt.$typeName, ...[] ) as `${typeof PKG_V1}::vault::TypusDepositReceipt`, typeArgs: [ ] as [], isPhantom: TypusDepositReceipt.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => TypusDepositReceipt.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TypusDepositReceipt.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => TypusDepositReceipt.fromBcs( data, ), bcs: TypusDepositReceipt.bcs, fromJSONField: (field: any) => TypusDepositReceipt.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => TypusDepositReceipt.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => TypusDepositReceipt.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => TypusDepositReceipt.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => TypusDepositReceipt.fetch( client, id, ), new: ( fields: TypusDepositReceiptFields, ) => { return new TypusDepositReceipt( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): TypusDepositReceipt { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTypusDepositReceipt(data.bcs.type)) { throw new Error(`object at is not a TypusDepositReceipt object`); }

 return TypusDepositReceipt.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return TypusDepositReceipt.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isUnsubscribe(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::Unsubscribe`; }
...
export class Unsubscribe implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::Unsubscribe`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Unsubscribe.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::Unsubscribe`; readonly $typeArgs: []; readonly $isPhantom = Unsubscribe.$isPhantom;

 readonly signer: ToField<"address">; readonly index: ToField<"u64">; readonly token: ToField<TypeName>; readonly amount: ToField<"u64">

 private constructor(typeArgs: [], fields: UnsubscribeFields, ) { this.$fullTypeName = composeSuiType( Unsubscribe.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::Unsubscribe`; this.$typeArgs = typeArgs;

 this.signer = fields.signer;; this.index = fields.index;; this.token = fields.token;; this.amount = fields.amount; }

 static reified( ): UnsubscribeReified { return { typeName: Unsubscribe.$typeName, fullTypeName: composeSuiType( Unsubscribe.$typeName, ...[] ) as `${typeof PKG_V1}::vault::Unsubscribe`, typeArgs: [ ] as [], isPhantom: Unsubscribe.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Unsubscribe.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Unsubscribe.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Unsubscribe.fromBcs( data, ), bcs: Unsubscribe.bcs, fromJSONField: (field: any) => Unsubscribe.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Unsubscribe.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Unsubscribe.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Unsubscribe.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Unsubscribe.fetch( client, id, ), new: ( fields: UnsubscribeFields, ) => { return new Unsubscribe( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): Unsubscribe { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isUnsubscribe(data.bcs.type)) { throw new Error(`object at is not a Unsubscribe object`); }

 return Unsubscribe.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Unsubscribe.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isUpdateFeeConfig(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::UpdateFeeConfig`; }
...
export class UpdateFeeConfig implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::UpdateFeeConfig`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UpdateFeeConfig.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::UpdateFeeConfig`; readonly $typeArgs: []; readonly $isPhantom = UpdateFeeConfig.$isPhantom;

 readonly signer: ToField<"address">; readonly index: ToField<"u64">; readonly prevFeeBp: ToField<"u64">; readonly feeBp: ToField<"u64">

 private constructor(typeArgs: [], fields: UpdateFeeConfigFields, ) { this.$fullTypeName = composeSuiType( UpdateFeeConfig.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::UpdateFeeConfig`; this.$typeArgs = typeArgs;

 this.signer = fields.signer;; this.index = fields.index;; this.prevFeeBp = fields.prevFeeBp;; this.feeBp = fields.feeBp; }

 static reified( ): UpdateFeeConfigReified { return { typeName: UpdateFeeConfig.$typeName, fullTypeName: composeSuiType( UpdateFeeConfig.$typeName, ...[] ) as `${typeof PKG_V1}::vault::UpdateFeeConfig`, typeArgs: [ ] as [], isPhantom: UpdateFeeConfig.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UpdateFeeConfig.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UpdateFeeConfig.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UpdateFeeConfig.fromBcs( data, ), bcs: UpdateFeeConfig.bcs, fromJSONField: (field: any) => UpdateFeeConfig.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UpdateFeeConfig.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UpdateFeeConfig.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UpdateFeeConfig.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UpdateFeeConfig.fetch( client, id, ), new: ( fields: UpdateFeeConfigFields, ) => { return new UpdateFeeConfig( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): UpdateFeeConfig { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isUpdateFeeConfig(data.bcs.type)) { throw new Error(`object at is not a UpdateFeeConfig object`); }

 return UpdateFeeConfig.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return UpdateFeeConfig.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isUpdateFeeShareConfig(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::UpdateFeeShareConfig`; }
...
export class UpdateFeeShareConfig implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::vault::UpdateFeeShareConfig`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UpdateFeeShareConfig.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::vault::UpdateFeeShareConfig`; readonly $typeArgs: []; readonly $isPhantom = UpdateFeeShareConfig.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: UpdateFeeShareConfigFields, ) { this.$fullTypeName = composeSuiType( UpdateFeeShareConfig.$typeName, ...typeArgs ) as `${typeof PKG_V1}::vault::UpdateFeeShareConfig`; this.$typeArgs = typeArgs;
 ...
 static reified( ): UpdateFeeShareConfigReified { return { typeName: UpdateFeeShareConfig.$typeName, fullTypeName: composeSuiType( UpdateFeeShareConfig.$typeName, ...[] ) as `${typeof PKG_V1}::vault::UpdateFeeShareConfig`, typeArgs: [ ] as [], isPhantom: UpdateFeeShareConfig.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UpdateFeeShareConfig.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UpdateFeeShareConfig.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UpdateFeeShareConfig.fromBcs( data, ), bcs: UpdateFeeShareConfig.bcs, fromJSONField: (field: any) => UpdateFeeShareConfig.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UpdateFeeShareConfig.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UpdateFeeShareConfig.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UpdateFeeShareConfig.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UpdateFeeShareConfig.fetch( client, id, ), new: ( fields: UpdateFeeShareConfigFields, ) => { return new UpdateFeeShareConfig( [], fields ) }, kind: "StructClassReified", } }
 ...
 signer: this.signer,index: this.index.toString(),prevFeeBp: this.prevFeeBp.toString(),prevSharedFeePool: fieldToJSON<Option<Vector<"u8">>>(`${Option.$typeName}<vector<u8>>`, this.prevSharedFeePool),feeBp: this.feeBp.toString(),sharedFeePool: fieldToJSON<Option<Vector<"u8">>>(`${Option.$typeName}<vector<u8>>`, this.sharedFeePool),
 ...
 static fromSuiObjectData( data: SuiObjectData ): UpdateFeeShareConfig { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isUpdateFeeShareConfig(data.bcs.type)) { throw new Error(`object at is not a UpdateFeeShareConfig object`); }

 return UpdateFeeShareConfig.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return UpdateFeeShareConfig.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isWithdraw(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::vault::Withdraw`; }
