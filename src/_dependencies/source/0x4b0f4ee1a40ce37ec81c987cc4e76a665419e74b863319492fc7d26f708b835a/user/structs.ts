...
export function isAddTailsExpAmount(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V2}::user::AddTailsExpAmount`;
}
...
export class AddTailsExpAmount implements StructClass {
    ...
    static readonly $typeName = `${PKG_V2}::user::AddTailsExpAmount`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: AddTailsExpAmountFields) {
        this.$fullTypeName = composeSuiType(AddTailsExpAmount.$typeName, ...typeArgs) as `${typeof PKG_V2}::user::AddTailsExpAmount`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): AddTailsExpAmountReified {
        return {
            ...
            fullTypeName: composeSuiType(AddTailsExpAmount.$typeName, ...[]) as `${typeof PKG_V2}::user::AddTailsExpAmount`,
            typeArgs: [] as [],
...
export function isRemoveTailsExpAmount(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V2}::user::RemoveTailsExpAmount`;
}
...
export class RemoveTailsExpAmount implements StructClass {
    ...
    static readonly $typeName = `${PKG_V2}::user::RemoveTailsExpAmount`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: RemoveTailsExpAmountFields) {
        this.$fullTypeName = composeSuiType(RemoveTailsExpAmount.$typeName, ...typeArgs) as `${typeof PKG_V2}::user::RemoveTailsExpAmount`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): RemoveTailsExpAmountReified {
        return {
            ...
            fullTypeName: composeSuiType(RemoveTailsExpAmount.$typeName, ...[]) as `${typeof PKG_V2}::user::RemoveTailsExpAmount`,
            typeArgs: [] as [],
