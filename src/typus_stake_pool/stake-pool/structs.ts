...
export class StakePoolRegistry implements StructClass {
    ...
    static reified(): StakePoolRegistryReified {
        const reifiedBcs = StakePoolRegistry.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => StakePoolRegistry.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof StakePoolRegistry.instantiateBcs> | null = null;
...
export class StakePool implements StructClass {
    ...
    static reified(): StakePoolReified {
        const reifiedBcs = StakePool.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => StakePool.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof StakePool.instantiateBcs> | null = null;
...
export class Incentive implements StructClass {
    ...
    static reified(): IncentiveReified {
        const reifiedBcs = Incentive.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => Incentive.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof Incentive.instantiateBcs> | null = null;
...
export class StakePoolInfo implements StructClass {
    ...
    static reified(): StakePoolInfoReified {
        const reifiedBcs = StakePoolInfo.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => StakePoolInfo.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof StakePoolInfo.instantiateBcs> | null = null;
...
export class StakePoolConfig implements StructClass {
    ...
    static reified(): StakePoolConfigReified {
        const reifiedBcs = StakePoolConfig.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => StakePoolConfig.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof StakePoolConfig.instantiateBcs> | null = null;
...
export class IncentiveConfig implements StructClass {
    ...
    static reified(): IncentiveConfigReified {
        const reifiedBcs = IncentiveConfig.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => IncentiveConfig.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof IncentiveConfig.instantiateBcs> | null = null;
...
export class IncentiveInfo implements StructClass {
    ...
    static reified(): IncentiveInfoReified {
        const reifiedBcs = IncentiveInfo.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => IncentiveInfo.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof IncentiveInfo.instantiateBcs> | null = null;
...
export class LpUserShare implements StructClass {
    ...
    static reified(): LpUserShareReified {
        const reifiedBcs = LpUserShare.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => LpUserShare.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof LpUserShare.instantiateBcs> | null = null;
...
export class DeactivatingShares implements StructClass {
    ...
    static reified(): DeactivatingSharesReified {
        const reifiedBcs = DeactivatingShares.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => DeactivatingShares.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof DeactivatingShares.instantiateBcs> | null = null;
...
export class NewStakePoolEvent implements StructClass {
    ...
    static reified(): NewStakePoolEventReified {
        const reifiedBcs = NewStakePoolEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => NewStakePoolEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof NewStakePoolEvent.instantiateBcs> | null = null;
...
export function isAutoCompoundEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V1}::stake_pool::AutoCompoundEvent`;
}
...
export class AutoCompoundEvent implements StructClass {
    __StructClass = true as const;

    static readonly $typeName = `${PKG_V1}::stake_pool::AutoCompoundEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = AutoCompoundEvent.$typeName;
    readonly $fullTypeName: `${typeof PKG_V1}::stake_pool::AutoCompoundEvent`;
    readonly $typeArgs: [];
    readonly $isPhantom = AutoCompoundEvent.$isPhantom;
    ...
    private constructor(typeArgs: [], fields: AutoCompoundEventFields) {
        this.$fullTypeName = composeSuiType(AutoCompoundEvent.$typeName, ...typeArgs) as `${typeof PKG_V1}::stake_pool::AutoCompoundEvent`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): AutoCompoundEventReified {
        const reifiedBcs = AutoCompoundEvent.bcs;
        return {
            typeName: AutoCompoundEvent.$typeName,
            fullTypeName: composeSuiType(AutoCompoundEvent.$typeName, ...[]) as `${typeof PKG_V1}::stake_pool::AutoCompoundEvent`,
            typeArgs: [] as [],
            isPhantom: AutoCompoundEvent.$isPhantom,
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) => AutoCompoundEvent.fromFields(fields),
            fromFieldsWithTypes: (item: FieldsWithTypes) => AutoCompoundEvent.fromFieldsWithTypes(item),
            fromBcs: (data: Uint8Array) => AutoCompoundEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
            fromJSONField: (field: any) => AutoCompoundEvent.fromJSONField(field),
            fromJSON: (json: Record<string, any>) => AutoCompoundEvent.fromJSON(json),
            fromSuiParsedData: (content: SuiParsedData) => AutoCompoundEvent.fromSuiParsedData(content),
            fromSuiObjectData: (content: SuiObjectData) => AutoCompoundEvent.fromSuiObjectData(content),
            fetch: async (client: SuiClient, id: string) => AutoCompoundEvent.fetch(client, id),
            new: (fields: AutoCompoundEventFields) => {
    ...
    static phantom(): PhantomReified<ToTypeStr<AutoCompoundEvent>> {
        return phantom(AutoCompoundEvent.reified());
    }
    static get p() {
    ...
    private static instantiateBcs() {
        return bcs.struct("AutoCompoundEvent", {
            sender: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val) }),
            index: bcs.u64(),
    ...
    private static cachedBcs: ReturnType<typeof AutoCompoundEvent.instantiateBcs> | null = null;
    ...
    static fromFields(fields: Record<string, any>): AutoCompoundEvent {
        return AutoCompoundEvent.reified().new({
            ...
            compoundUsers: decodeFromFields("u64", fields.compound_users),
            totalUsers: decodeFromFields("u64", fields.total_users),
            u64Padding: decodeFromFields(reified.vector("u64"), fields.u64_padding),
        });
    }
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): AutoCompoundEvent {
        ...
        return AutoCompoundEvent.reified().new({
            ...
            compoundUsers: decodeFromFieldsWithTypes("u64", item.fields.compound_users),
            totalUsers: decodeFromFieldsWithTypes("u64", item.fields.total_users),
            u64Padding: decodeFromFieldsWithTypes(reified.vector("u64"), item.fields.u64_padding),
        });
    }
    ...
    static fromJSONField(field: any): AutoCompoundEvent {
        return AutoCompoundEvent.reified().new({
            ...
            compoundUsers: decodeFromJSONField("u64", field.compoundUsers),
            totalUsers: decodeFromJSONField("u64", field.totalUsers),
            u64Padding: decodeFromJSONField(reified.vector("u64"), field.u64Padding),
        });
    }
    ...
    static fromSuiParsedData(content: SuiParsedData): AutoCompoundEvent {
        ...
        if (!isAutoCompoundEvent(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a AutoCompoundEvent object`);
        }
    ...
    static fromSuiObjectData(data: SuiObjectData): AutoCompoundEvent {
        if (data.bcs) {
            ...
            return AutoCompoundEvent.fromBcs(fromB64(data.bcs.bcsBytes));
        }
        if (data.content) {
    ...
    static async fetch(client: SuiClient, id: string): Promise<AutoCompoundEvent> {
        const res = await client.getObject({ id, options: { showBcs: true } });
        if (res.error) {
            throw new Error(`error fetching AutoCompoundEvent object at id ${id}: ${res.error.code}`);
        }
        if (res.data?.bcs?.dataType !== "moveObject" || !isAutoCompoundEvent(res.data.bcs.type)) {
            throw new Error(`object at id ${id} is not a AutoCompoundEvent object`);
        }

        return AutoCompoundEvent.fromSuiObjectData(res.data);
    }
}
...
export class AddIncentiveTokenEvent implements StructClass {
    ...
    static reified(): AddIncentiveTokenEventReified {
        const reifiedBcs = AddIncentiveTokenEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => AddIncentiveTokenEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof AddIncentiveTokenEvent.instantiateBcs> | null = null;
...
export class DeactivateIncentiveTokenEvent implements StructClass {
    ...
    static reified(): DeactivateIncentiveTokenEventReified {
        const reifiedBcs = DeactivateIncentiveTokenEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => DeactivateIncentiveTokenEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof DeactivateIncentiveTokenEvent.instantiateBcs> | null = null;
...
export class ActivateIncentiveTokenEvent implements StructClass {
    ...
    static reified(): ActivateIncentiveTokenEventReified {
        const reifiedBcs = ActivateIncentiveTokenEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => ActivateIncentiveTokenEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof ActivateIncentiveTokenEvent.instantiateBcs> | null = null;
...
export class RemoveIncentiveTokenEvent implements StructClass {
    ...
    static reified(): RemoveIncentiveTokenEventReified {
        const reifiedBcs = RemoveIncentiveTokenEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => RemoveIncentiveTokenEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof RemoveIncentiveTokenEvent.instantiateBcs> | null = null;
...
export class UpdateUnlockCountdownTsMsEvent implements StructClass {
    ...
    static reified(): UpdateUnlockCountdownTsMsEventReified {
        const reifiedBcs = UpdateUnlockCountdownTsMsEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => UpdateUnlockCountdownTsMsEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof UpdateUnlockCountdownTsMsEvent.instantiateBcs> | null = null;
...
export class UpdateIncentiveConfigEvent implements StructClass {
    ...
    static reified(): UpdateIncentiveConfigEventReified {
        const reifiedBcs = UpdateIncentiveConfigEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => UpdateIncentiveConfigEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof UpdateIncentiveConfigEvent.instantiateBcs> | null = null;
...
export class DepositIncentiveEvent implements StructClass {
    ...
    static reified(): DepositIncentiveEventReified {
        const reifiedBcs = DepositIncentiveEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => DepositIncentiveEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof DepositIncentiveEvent.instantiateBcs> | null = null;
...
export class WithdrawIncentiveEvent implements StructClass {
    ...
    static reified(): WithdrawIncentiveEventReified {
        const reifiedBcs = WithdrawIncentiveEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => WithdrawIncentiveEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof WithdrawIncentiveEvent.instantiateBcs> | null = null;
...
export class StakeEvent implements StructClass {
    ...
    static reified(): StakeEventReified {
        const reifiedBcs = StakeEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => StakeEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof StakeEvent.instantiateBcs> | null = null;
...
export class UpdatePoolInfoU64PaddingEvent implements StructClass {
    ...
    static reified(): UpdatePoolInfoU64PaddingEventReified {
        const reifiedBcs = UpdatePoolInfoU64PaddingEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => UpdatePoolInfoU64PaddingEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof UpdatePoolInfoU64PaddingEvent.instantiateBcs> | null = null;
...
export class SnapshotEvent implements StructClass {
    ...
    static reified(): SnapshotEventReified {
        const reifiedBcs = SnapshotEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => SnapshotEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof SnapshotEvent.instantiateBcs> | null = null;
...
export class UnsubscribeEvent implements StructClass {
    ...
    static reified(): UnsubscribeEventReified {
        const reifiedBcs = UnsubscribeEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => UnsubscribeEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof UnsubscribeEvent.instantiateBcs> | null = null;
...
export class UnstakeEvent implements StructClass {
    ...
    static reified(): UnstakeEventReified {
        const reifiedBcs = UnstakeEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => UnstakeEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof UnstakeEvent.instantiateBcs> | null = null;
...
export class HarvestPerUserShareEvent implements StructClass {
    ...
    static reified(): HarvestPerUserShareEventReified {
        const reifiedBcs = HarvestPerUserShareEvent.bcs;
        return {
            ...
            fromBcs: (data: Uint8Array) => HarvestPerUserShareEvent.fromFields(reifiedBcs.parse(data)),
            bcs: reifiedBcs,
    ...
    private static cachedBcs: ReturnType<typeof HarvestPerUserShareEvent.instantiateBcs> | null = null;
