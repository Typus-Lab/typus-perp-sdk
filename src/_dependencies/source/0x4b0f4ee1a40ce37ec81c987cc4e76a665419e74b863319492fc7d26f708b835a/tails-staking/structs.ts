...
export function isClaimProfitSharingEvent(type: string): boolean {
    ...
    return type === `${PKG_V3}::tails_staking::ClaimProfitSharingEvent`;
}
...
export class ClaimProfitSharingEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V3}::tails_staking::ClaimProfitSharingEvent`;
    ...
    private constructor(typeArgs: [], fields: ClaimProfitSharingEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V3}::tails_staking::ClaimProfitSharingEvent`;
...
export function isDailySignUpEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V3}::tails_staking::DailySignUpEvent`;
}
...
export class DailySignUpEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V3}::tails_staking::DailySignUpEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: DailySignUpEventFields) {
        this.$fullTypeName = composeSuiType(DailySignUpEvent.$typeName, ...typeArgs) as `${typeof PKG_V3}::tails_staking::DailySignUpEvent`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): DailySignUpEventReified {
        return {
            ...
            fullTypeName: composeSuiType(DailySignUpEvent.$typeName, ...[]) as `${typeof PKG_V3}::tails_staking::DailySignUpEvent`,
            typeArgs: [] as [],
...
export function isExpDownEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V6}::tails_staking::ExpDownEvent`;
}
...
export class ExpDownEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V6}::tails_staking::ExpDownEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: ExpDownEventFields) {
        this.$fullTypeName = composeSuiType(ExpDownEvent.$typeName, ...typeArgs) as `${typeof PKG_V6}::tails_staking::ExpDownEvent`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): ExpDownEventReified {
        return {
            ...
            fullTypeName: composeSuiType(ExpDownEvent.$typeName, ...[]) as `${typeof PKG_V6}::tails_staking::ExpDownEvent`,
            typeArgs: [] as [],
    ...
    static get bcs() {
        return bcs.struct("ExpDownEvent", {
            tails: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val) }),
            log: bcs.vector(bcs.u64()),
            bcs_padding: bcs.vector(bcs.vector(bcs.u8())),
        });
    }
...
export function isExpUpEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V3}::tails_staking::ExpUpEvent`;
}
...
export class ExpUpEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V3}::tails_staking::ExpUpEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: ExpUpEventFields) {
        this.$fullTypeName = composeSuiType(ExpUpEvent.$typeName, ...typeArgs) as `${typeof PKG_V3}::tails_staking::ExpUpEvent`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): ExpUpEventReified {
        return {
            ...
            fullTypeName: composeSuiType(ExpUpEvent.$typeName, ...[]) as `${typeof PKG_V3}::tails_staking::ExpUpEvent`,
            typeArgs: [] as [],
...
export function isLevelUpEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V3}::tails_staking::LevelUpEvent`;
}
...
export class LevelUpEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V3}::tails_staking::LevelUpEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: LevelUpEventFields) {
        this.$fullTypeName = composeSuiType(LevelUpEvent.$typeName, ...typeArgs) as `${typeof PKG_V3}::tails_staking::LevelUpEvent`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): LevelUpEventReified {
        return {
            ...
            fullTypeName: composeSuiType(LevelUpEvent.$typeName, ...[]) as `${typeof PKG_V3}::tails_staking::LevelUpEvent`,
            typeArgs: [] as [],
...
export function isRemoveProfitSharingEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V3}::tails_staking::RemoveProfitSharingEvent`;
}
...
export class RemoveProfitSharingEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V3}::tails_staking::RemoveProfitSharingEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: RemoveProfitSharingEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V3}::tails_staking::RemoveProfitSharingEvent`;
        this.$typeArgs = typeArgs;
...
export function isSetProfitSharingEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V3}::tails_staking::SetProfitSharingEvent`;
}
...
export class SetProfitSharingEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V3}::tails_staking::SetProfitSharingEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: SetProfitSharingEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V3}::tails_staking::SetProfitSharingEvent`;
        this.$typeArgs = typeArgs;
...
export function isStakeTailsEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V3}::tails_staking::StakeTailsEvent`;
}
...
export class StakeTailsEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V3}::tails_staking::StakeTailsEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: StakeTailsEventFields) {
        this.$fullTypeName = composeSuiType(StakeTailsEvent.$typeName, ...typeArgs) as `${typeof PKG_V3}::tails_staking::StakeTailsEvent`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): StakeTailsEventReified {
        return {
            ...
            fullTypeName: composeSuiType(StakeTailsEvent.$typeName, ...[]) as `${typeof PKG_V3}::tails_staking::StakeTailsEvent`,
            typeArgs: [] as [],
...
export function isStakingInfo(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V3}::tails_staking::StakingInfo`;
}
...
export class StakingInfo implements StructClass {
    ...
    static readonly $typeName = `${PKG_V3}::tails_staking::StakingInfo`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: StakingInfoFields) {
        this.$fullTypeName = composeSuiType(StakingInfo.$typeName, ...typeArgs) as `${typeof PKG_V3}::tails_staking::StakingInfo`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): StakingInfoReified {
        return {
            ...
            fullTypeName: composeSuiType(StakingInfo.$typeName, ...[]) as `${typeof PKG_V3}::tails_staking::StakingInfo`,
            typeArgs: [] as [],
...
export function isTailsStakingRegistry(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V3}::tails_staking::TailsStakingRegistry`;
}
...
export class TailsStakingRegistry implements StructClass {
    ...
    static readonly $typeName = `${PKG_V3}::tails_staking::TailsStakingRegistry`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: TailsStakingRegistryFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V3}::tails_staking::TailsStakingRegistry`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): TailsStakingRegistryReified {
        return {
            ...
            fullTypeName: composeSuiType(TailsStakingRegistry.$typeName, ...[]) as `${typeof PKG_V3}::tails_staking::TailsStakingRegistry`,
            typeArgs: [] as [],
...
export function isTransferTailsEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V3}::tails_staking::TransferTailsEvent`;
}
...
export class TransferTailsEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V3}::tails_staking::TransferTailsEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: TransferTailsEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V3}::tails_staking::TransferTailsEvent`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): TransferTailsEventReified {
        return {
            ...
            fullTypeName: composeSuiType(TransferTailsEvent.$typeName, ...[]) as `${typeof PKG_V3}::tails_staking::TransferTailsEvent`,
            typeArgs: [] as [],
...
export function isUnstakeTailsEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V3}::tails_staking::UnstakeTailsEvent`;
}
...
export class UnstakeTailsEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V3}::tails_staking::UnstakeTailsEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: UnstakeTailsEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V3}::tails_staking::UnstakeTailsEvent`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): UnstakeTailsEventReified {
        return {
            ...
            fullTypeName: composeSuiType(UnstakeTailsEvent.$typeName, ...[]) as `${typeof PKG_V3}::tails_staking::UnstakeTailsEvent`,
            typeArgs: [] as [],
...
export function isUpdateTailsStakingRegistryConfigEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V3}::tails_staking::UpdateTailsStakingRegistryConfigEvent`;
}
...
export class UpdateTailsStakingRegistryConfigEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V3}::tails_staking::UpdateTailsStakingRegistryConfigEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;
    ...
    private constructor(typeArgs: [], fields: UpdateTailsStakingRegistryConfigEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V3}::tails_staking::UpdateTailsStakingRegistryConfigEvent`;
        this.$typeArgs = typeArgs;
