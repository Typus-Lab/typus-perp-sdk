...
export function isDeductEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V5}::leaderboard::DeductEvent`;
}
...
export class DeductEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V5}::leaderboard::DeductEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = DeductEvent.$typeName;
    readonly $fullTypeName: `${typeof PKG_V5}::leaderboard::DeductEvent`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: DeductEventFields) {
        this.$fullTypeName = composeSuiType(DeductEvent.$typeName, ...typeArgs) as `${typeof PKG_V5}::leaderboard::DeductEvent`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): DeductEventReified {
        return {
            ...
            fullTypeName: composeSuiType(DeductEvent.$typeName, ...[]) as `${typeof PKG_V5}::leaderboard::DeductEvent`,
            typeArgs: [] as [],
...
export function isExtendLeaderboardEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V1}::leaderboard::ExtendLeaderboardEvent`;
}
...
export class ExtendLeaderboardEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V1}::leaderboard::ExtendLeaderboardEvent`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = ExtendLeaderboardEvent.$typeName;
    readonly $fullTypeName: `${typeof PKG_V1}::leaderboard::ExtendLeaderboardEvent`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: ExtendLeaderboardEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V1}::leaderboard::ExtendLeaderboardEvent`;
        this.$typeArgs = typeArgs;
