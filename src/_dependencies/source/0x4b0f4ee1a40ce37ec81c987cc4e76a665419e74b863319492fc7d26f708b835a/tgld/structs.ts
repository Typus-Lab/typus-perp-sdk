...
export function isBurnEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::tgld::BurnEvent`; }
...
export class BurnEvent implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::tgld::BurnEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = BurnEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::tgld::BurnEvent`; readonly $typeArgs: []; readonly $isPhantom = BurnEvent.$isPhantom;

 readonly log: ToField<Vector<"u64">>; readonly bcsPadding: ToField<Vector<Vector<"u8">>>

 private constructor(typeArgs: [], fields: BurnEventFields, ) { this.$fullTypeName = composeSuiType( BurnEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::tgld::BurnEvent`; this.$typeArgs = typeArgs;

 this.log = fields.log;; this.bcsPadding = fields.bcsPadding; }

 static reified( ): BurnEventReified { return { typeName: BurnEvent.$typeName, fullTypeName: composeSuiType( BurnEvent.$typeName, ...[] ) as `${typeof PKG_V1}::tgld::BurnEvent`, typeArgs: [ ] as [], isPhantom: BurnEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => BurnEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => BurnEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => BurnEvent.fromBcs( data, ), bcs: BurnEvent.bcs, fromJSONField: (field: any) => BurnEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => BurnEvent.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => BurnEvent.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => BurnEvent.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => BurnEvent.fetch( client, id, ), new: ( fields: BurnEventFields, ) => { return new BurnEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): BurnEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBurnEvent(data.bcs.type)) { throw new Error(`object at is not a BurnEvent object`); }

 return BurnEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return BurnEvent.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isMintEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::tgld::MintEvent`; }
...
export function isTGLD(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::tgld::TGLD`; }

export interface TGLDFields { dummyField: ToField<"bool"> }

export type TGLDReified = Reified< TGLD, TGLDFields >;

export class TGLD implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::tgld::TGLD`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = TGLD.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::tgld::TGLD`; readonly $typeArgs: []; readonly $isPhantom = TGLD.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: TGLDFields, ) { this.$fullTypeName = composeSuiType( TGLD.$typeName, ...typeArgs ) as `${typeof PKG_V1}::tgld::TGLD`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): TGLDReified { return { typeName: TGLD.$typeName, fullTypeName: composeSuiType( TGLD.$typeName, ...[] ) as `${typeof PKG_V1}::tgld::TGLD`, typeArgs: [ ] as [], isPhantom: TGLD.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => TGLD.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TGLD.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => TGLD.fromBcs( data, ), bcs: TGLD.bcs, fromJSONField: (field: any) => TGLD.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => TGLD.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => TGLD.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => TGLD.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => TGLD.fetch( client, id, ), new: ( fields: TGLDFields, ) => { return new TGLD( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): TGLD { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTGLD(data.bcs.type)) { throw new Error(`object at is not a TGLD object`); }

 return TGLD.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return TGLD.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isTgldRegistry(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::tgld::TgldRegistry`; }
...
export class TgldRegistry implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::tgld::TgldRegistry`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = TgldRegistry.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::tgld::TgldRegistry`; readonly $typeArgs: []; readonly $isPhantom = TgldRegistry.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: TgldRegistryFields, ) { this.$fullTypeName = composeSuiType( TgldRegistry.$typeName, ...typeArgs ) as `${typeof PKG_V1}::tgld::TgldRegistry`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.treasuryCap = fields.treasuryCap;; this.tokenPolicyCap = fields.tokenPolicyCap; }

 static reified( ): TgldRegistryReified { return { typeName: TgldRegistry.$typeName, fullTypeName: composeSuiType( TgldRegistry.$typeName, ...[] ) as `${typeof PKG_V1}::tgld::TgldRegistry`, typeArgs: [ ] as [], isPhantom: TgldRegistry.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => TgldRegistry.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TgldRegistry.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => TgldRegistry.fromBcs( data, ), bcs: TgldRegistry.bcs, fromJSONField: (field: any) => TgldRegistry.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => TgldRegistry.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => TgldRegistry.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => TgldRegistry.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => TgldRegistry.fetch( client, id, ), new: ( fields: TgldRegistryFields, ) => { return new TgldRegistry( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): TgldRegistry { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTgldRegistry(data.bcs.type)) { throw new Error(`object at is not a TgldRegistry object`); }

 return TgldRegistry.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return TgldRegistry.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
