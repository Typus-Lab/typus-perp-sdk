...
export const OptionCollateralInfo = new MoveStruct({ name: `${$moduleName}::OptionCollateralInfo`, fields: {
...
export const TradingOrder = new MoveStruct({ name: `${$moduleName}::TradingOrder`, fields: {
        id: object.UID,
...
export const RemovePositionEvent = new MoveStruct({ name: `${$moduleName}::RemovePositionEvent`, fields: {
        user: bcs.Address,
        collateral_token: type_name.TypeName,
        symbol: symbol.Symbol,
        linked_order_ids: bcs.vector(bcs.u64()),
...
export const OrderFilledEvent = new MoveStruct({ name: `${$moduleName}::OrderFilledEvent`, fields: {
        user: bcs.Address,
        collateral_token: type_name.TypeName,
        symbol: symbol.Symbol,
        order_id: bcs.u64(),
...
export const RealizeFundingEvent = new MoveStruct({ name: `${$moduleName}::RealizeFundingEvent`, fields: {
        user: bcs.Address,
        collateral_token: type_name.TypeName,
        symbol: symbol.Symbol,
        position_id: bcs.u64(),
