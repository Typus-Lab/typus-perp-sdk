...
export const FeeInfo = new MoveStruct({ name: `${$moduleName}::FeeInfo`, fields: {
        /** The type name of the token. */
        token: type_name.TypeName,
        /** The amount of fees collected. */
        value: bcs.u64()
    } });
export const FeePool = new MoveStruct({ name: `${$moduleName}::FeePool`, fields: {
        id: object.UID,
...
export const SendFeeEvent = new MoveStruct({ name: `${$moduleName}::SendFeeEvent`, fields: {
        /** The type name of the token. */
        token: type_name.TypeName,
        /** The amount of fees sent. */
        amount: bcs.u64()
    } });
export const ProtocolFeeEvent = new MoveStruct({ name: `${$moduleName}::ProtocolFeeEvent`, fields: {
        /** The type name of the token. */
        token: type_name.TypeName,
        /** The amount of fees charged. */
        amount: bcs.u64()
    } });
export const PutInsuranceFundEvent = new MoveStruct({ name: `${$moduleName}::PutInsuranceFundEvent`, fields: {
        /** The type name of the token. */
        token: type_name.TypeName,
