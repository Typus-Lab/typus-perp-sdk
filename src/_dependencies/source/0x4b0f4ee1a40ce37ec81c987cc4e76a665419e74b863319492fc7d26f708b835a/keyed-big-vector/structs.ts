...
export function isElement(type: string): boolean {
    ...
    return type.startsWith(`${PKG_V12}::keyed_big_vector::Element` + "<");
}
...
export class Element<K extends TypeArgument, V extends TypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V12}::keyed_big_vector::Element`;
    static readonly $numTypeParams = 2;
    static readonly $isPhantom = [false, false] as const;

    readonly $typeName = Element.$typeName;
    readonly $fullTypeName: `${typeof PKG_V12}::keyed_big_vector::Element<${ToTypeStr<K>}, ${ToTypeStr<V>}>`;
    ...
    private constructor(typeArgs: [ToTypeStr<K>, ToTypeStr<V>], fields: ElementFields<K, V>) {
        this.$fullTypeName = composeSuiType(
            Element.$typeName,
            ...typeArgs
        ) as `${typeof PKG_V12}::keyed_big_vector::Element<${ToTypeStr<K>}, ${ToTypeStr<V>}>`;
    ...
    static reified<K extends Reified<TypeArgument, any>, V extends Reified<TypeArgument, any>>(
        ...
        return {
            ...
            ) as `${typeof PKG_V12}::keyed_big_vector::Element<${ToTypeStr<ToTypeArgument<K>>}, ${ToTypeStr<ToTypeArgument<V>>}>`,
...
export function isKeyedBigVector(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V12}::keyed_big_vector::KeyedBigVector`;
}
...
export class KeyedBigVector implements StructClass {
    ...
    static readonly $typeName = `${PKG_V12}::keyed_big_vector::KeyedBigVector`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = KeyedBigVector.$typeName;
    readonly $fullTypeName: `${typeof PKG_V12}::keyed_big_vector::KeyedBigVector`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: KeyedBigVectorFields) {
        this.$fullTypeName = composeSuiType(KeyedBigVector.$typeName, ...typeArgs) as `${typeof PKG_V12}::keyed_big_vector::KeyedBigVector`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): KeyedBigVectorReified {
        return {
            ...
            fullTypeName: composeSuiType(KeyedBigVector.$typeName, ...[]) as `${typeof PKG_V12}::keyed_big_vector::KeyedBigVector`,
            typeArgs: [] as [],
...
export function isSlice(type: string): boolean {
    type = compressSuiType(type);
    return type.startsWith(`${PKG_V12}::keyed_big_vector::Slice` + "<");
}
...
export class Slice<K extends TypeArgument, V extends TypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V12}::keyed_big_vector::Slice`;
    static readonly $numTypeParams = 2;
    static readonly $isPhantom = [false, false] as const;

    readonly $typeName = Slice.$typeName;
    readonly $fullTypeName: `${typeof PKG_V12}::keyed_big_vector::Slice<${ToTypeStr<K>}, ${ToTypeStr<V>}>`;
    readonly $typeArgs: [ToTypeStr<K>, ToTypeStr<V>];
    ...
    private constructor(typeArgs: [ToTypeStr<K>, ToTypeStr<V>], fields: SliceFields<K, V>) {
        this.$fullTypeName = composeSuiType(
            Slice.$typeName,
            ...typeArgs
        ) as `${typeof PKG_V12}::keyed_big_vector::Slice<${ToTypeStr<K>}, ${ToTypeStr<V>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<K extends Reified<TypeArgument, any>, V extends Reified<TypeArgument, any>>(
        ...
        return {
            ...
            fullTypeName: composeSuiType(
                Slice.$typeName,
                ...[extractType(K), extractType(V)]
            ) as `${typeof PKG_V12}::keyed_big_vector::Slice<${ToTypeStr<ToTypeArgument<K>>}, ${ToTypeStr<ToTypeArgument<V>>}>`,
            typeArgs: [extractType(K), extractType(V)] as [ToTypeStr<ToTypeArgument<K>>, ToTypeStr<ToTypeArgument<V>>],
