...
export const StakePoolRegistry = new MoveStruct({ name: `${$moduleName}::StakePoolRegistry`, fields: {
        id: object.UID,
        /** The number of pools in the registry. */
        num_pool: bcs.u64()
    } });
export const StakePoolInfo = new MoveStruct({ name: `${$moduleName}::StakePoolInfo`, fields: {
...
export const StakePoolConfig = new MoveStruct({ name: `${$moduleName}::StakePoolConfig`, fields: {
...
export const IncentiveConfig = new MoveStruct({ name: `${$moduleName}::IncentiveConfig`, fields: {
...
export const IncentiveInfo = new MoveStruct({ name: `${$moduleName}::IncentiveInfo`, fields: {
...
export const Incentive = new MoveStruct({ name: `${$moduleName}::Incentive`, fields: {
...
export const StakePool = new MoveStruct({ name: `${$moduleName}::StakePool`, fields: {
        id: object.UID,
...
export const LpUserShare = new MoveStruct({ name: `${$moduleName}::LpUserShare`, fields: {
...
export const NewStakePoolEvent = new MoveStruct({ name: `${$moduleName}::NewStakePoolEvent`, fields: {
        sender: bcs.Address,
        stake_pool_info: StakePoolInfo,
        stake_pool_config: StakePoolConfig,
        u64_padding: bcs.vector(bcs.u64())
    } });
export const AutoCompoundEvent = new MoveStruct({ name: `${$moduleName}::AutoCompoundEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
...
export const AddIncentiveTokenEvent = new MoveStruct({ name: `${$moduleName}::AddIncentiveTokenEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
        incentive_token: type_name.TypeName,
...
export const DeactivateStakePoolEvent = new MoveStruct({ name: `${$moduleName}::DeactivateStakePoolEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
        u64_padding: bcs.vector(bcs.u64())
    } });
export const ActivateStakePoolEvent = new MoveStruct({ name: `${$moduleName}::ActivateStakePoolEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
        u64_padding: bcs.vector(bcs.u64())
    } });
export const DeactivateIncentiveTokenEvent = new MoveStruct({ name: `${$moduleName}::DeactivateIncentiveTokenEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
        incentive_token: type_name.TypeName,
        u64_padding: bcs.vector(bcs.u64())
    } });
export const ActivateIncentiveTokenEvent = new MoveStruct({ name: `${$moduleName}::ActivateIncentiveTokenEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
        incentive_token: type_name.TypeName,
        u64_padding: bcs.vector(bcs.u64())
    } });
export const RemoveIncentiveTokenEvent = new MoveStruct({ name: `${$moduleName}::RemoveIncentiveTokenEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
        incentive_token: type_name.TypeName,
...
export const UpdateIncentiveConfigEvent = new MoveStruct({ name: `${$moduleName}::UpdateIncentiveConfigEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
...
export const DepositIncentiveEvent = new MoveStruct({ name: `${$moduleName}::DepositIncentiveEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
...
export const WithdrawIncentiveEvent = new MoveStruct({ name: `${$moduleName}::WithdrawIncentiveEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
        incentive_token_type: type_name.TypeName,
...
export const StakeEvent = new MoveStruct({ name: `${$moduleName}::StakeEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
...
export const UpdatePoolInfoU64PaddingEvent = new MoveStruct({ name: `${$moduleName}::UpdatePoolInfoU64PaddingEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
        u64_padding: bcs.vector(bcs.u64())
    } });
export const SnapshotEvent = new MoveStruct({ name: `${$moduleName}::SnapshotEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
        user_share_id: bcs.u64(),
        shares: bcs.u64(),
...
export const UnsubscribeEvent = new MoveStruct({ name: `${$moduleName}::UnsubscribeEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
        lp_token_type: type_name.TypeName,
        user_share_id: bcs.u64(),
...
export const UnstakeEvent = new MoveStruct({ name: `${$moduleName}::UnstakeEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
        lp_token_type: type_name.TypeName,
        user_share_id: bcs.u64(),
...
export const HarvestPerUserShareEvent = new MoveStruct({ name: `${$moduleName}::HarvestPerUserShareEvent`, fields: {
        sender: bcs.Address,
        index: bcs.u64(),
        incentive_token_type: type_name.TypeName,
