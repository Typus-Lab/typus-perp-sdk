...
export function isAddAccumulatedTgldAmount(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::user::AddAccumulatedTgldAmount`; }
...
export class AddAccumulatedTgldAmount implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::user::AddAccumulatedTgldAmount`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = AddAccumulatedTgldAmount.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::user::AddAccumulatedTgldAmount`; readonly $typeArgs: []; readonly $isPhantom = AddAccumulatedTgldAmount.$isPhantom;

 readonly user: ToField<"address">; readonly log: ToField<Vector<"u64">>; readonly bcsPadding: ToField<Vector<Vector<"u8">>>

 private constructor(typeArgs: [], fields: AddAccumulatedTgldAmountFields, ) { this.$fullTypeName = composeSuiType( AddAccumulatedTgldAmount.$typeName, ...typeArgs ) as `${typeof PKG_V1}::user::AddAccumulatedTgldAmount`; this.$typeArgs = typeArgs;

 this.user = fields.user;; this.log = fields.log;; this.bcsPadding = fields.bcsPadding; }

 static reified( ): AddAccumulatedTgldAmountReified { return { typeName: AddAccumulatedTgldAmount.$typeName, fullTypeName: composeSuiType( AddAccumulatedTgldAmount.$typeName, ...[] ) as `${typeof PKG_V1}::user::AddAccumulatedTgldAmount`, typeArgs: [ ] as [], isPhantom: AddAccumulatedTgldAmount.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => AddAccumulatedTgldAmount.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => AddAccumulatedTgldAmount.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => AddAccumulatedTgldAmount.fromBcs( data, ), bcs: AddAccumulatedTgldAmount.bcs, fromJSONField: (field: any) => AddAccumulatedTgldAmount.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => AddAccumulatedTgldAmount.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => AddAccumulatedTgldAmount.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => AddAccumulatedTgldAmount.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => AddAccumulatedTgldAmount.fetch( client, id, ), new: ( fields: AddAccumulatedTgldAmountFields, ) => { return new AddAccumulatedTgldAmount( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): AddAccumulatedTgldAmount { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isAddAccumulatedTgldAmount(data.bcs.type)) { throw new Error(`object at is not a AddAccumulatedTgldAmount object`); }

 return AddAccumulatedTgldAmount.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return AddAccumulatedTgldAmount.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isAddTailsExpAmount(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V2}::user::AddTailsExpAmount`; }
...
export class AddTailsExpAmount implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V2}::user::AddTailsExpAmount`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = AddTailsExpAmount.$typeName; readonly $fullTypeName: `${typeof PKG_V2}::user::AddTailsExpAmount`; readonly $typeArgs: []; readonly $isPhantom = AddTailsExpAmount.$isPhantom;

 readonly user: ToField<"address">; readonly log: ToField<Vector<"u64">>; readonly bcsPadding: ToField<Vector<Vector<"u8">>>

 private constructor(typeArgs: [], fields: AddTailsExpAmountFields, ) { this.$fullTypeName = composeSuiType( AddTailsExpAmount.$typeName, ...typeArgs ) as `${typeof PKG_V2}::user::AddTailsExpAmount`; this.$typeArgs = typeArgs;

 this.user = fields.user;; this.log = fields.log;; this.bcsPadding = fields.bcsPadding; }

 static reified( ): AddTailsExpAmountReified { return { typeName: AddTailsExpAmount.$typeName, fullTypeName: composeSuiType( AddTailsExpAmount.$typeName, ...[] ) as `${typeof PKG_V2}::user::AddTailsExpAmount`, typeArgs: [ ] as [], isPhantom: AddTailsExpAmount.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => AddTailsExpAmount.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => AddTailsExpAmount.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => AddTailsExpAmount.fromBcs( data, ), bcs: AddTailsExpAmount.bcs, fromJSONField: (field: any) => AddTailsExpAmount.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => AddTailsExpAmount.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => AddTailsExpAmount.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => AddTailsExpAmount.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => AddTailsExpAmount.fetch( client, id, ), new: ( fields: AddTailsExpAmountFields, ) => { return new AddTailsExpAmount( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): AddTailsExpAmount { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isAddTailsExpAmount(data.bcs.type)) { throw new Error(`object at is not a AddTailsExpAmount object`); }

 return AddTailsExpAmount.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return AddTailsExpAmount.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isMetadata(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::user::Metadata`; }
...
export class Metadata implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::user::Metadata`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Metadata.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::user::Metadata`; readonly $typeArgs: []; readonly $isPhantom = Metadata.$isPhantom;

 readonly content: ToField<Vector<"u64">>

 private constructor(typeArgs: [], fields: MetadataFields, ) { this.$fullTypeName = composeSuiType( Metadata.$typeName, ...typeArgs ) as `${typeof PKG_V1}::user::Metadata`; this.$typeArgs = typeArgs;

 this.content = fields.content; }

 static reified( ): MetadataReified { return { typeName: Metadata.$typeName, fullTypeName: composeSuiType( Metadata.$typeName, ...[] ) as `${typeof PKG_V1}::user::Metadata`, typeArgs: [ ] as [], isPhantom: Metadata.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Metadata.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Metadata.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Metadata.fromBcs( data, ), bcs: Metadata.bcs, fromJSONField: (field: any) => Metadata.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Metadata.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Metadata.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Metadata.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Metadata.fetch( client, id, ), new: ( fields: MetadataFields, ) => { return new Metadata( [], fields ) }, kind: "StructClassReified", } }
...
export function isRemoveTailsExpAmount(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V2}::user::RemoveTailsExpAmount`; }
...
export class RemoveTailsExpAmount implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V2}::user::RemoveTailsExpAmount`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = RemoveTailsExpAmount.$typeName; readonly $fullTypeName: `${typeof PKG_V2}::user::RemoveTailsExpAmount`; readonly $typeArgs: []; readonly $isPhantom = RemoveTailsExpAmount.$isPhantom;

 readonly user: ToField<"address">; readonly log: ToField<Vector<"u64">>; readonly bcsPadding: ToField<Vector<Vector<"u8">>>

 private constructor(typeArgs: [], fields: RemoveTailsExpAmountFields, ) { this.$fullTypeName = composeSuiType( RemoveTailsExpAmount.$typeName, ...typeArgs ) as `${typeof PKG_V2}::user::RemoveTailsExpAmount`; this.$typeArgs = typeArgs;

 this.user = fields.user;; this.log = fields.log;; this.bcsPadding = fields.bcsPadding; }

 static reified( ): RemoveTailsExpAmountReified { return { typeName: RemoveTailsExpAmount.$typeName, fullTypeName: composeSuiType( RemoveTailsExpAmount.$typeName, ...[] ) as `${typeof PKG_V2}::user::RemoveTailsExpAmount`, typeArgs: [ ] as [], isPhantom: RemoveTailsExpAmount.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => RemoveTailsExpAmount.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => RemoveTailsExpAmount.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => RemoveTailsExpAmount.fromBcs( data, ), bcs: RemoveTailsExpAmount.bcs, fromJSONField: (field: any) => RemoveTailsExpAmount.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => RemoveTailsExpAmount.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => RemoveTailsExpAmount.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => RemoveTailsExpAmount.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => RemoveTailsExpAmount.fetch( client, id, ), new: ( fields: RemoveTailsExpAmountFields, ) => { return new RemoveTailsExpAmount( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): RemoveTailsExpAmount { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isRemoveTailsExpAmount(data.bcs.type)) { throw new Error(`object at is not a RemoveTailsExpAmount object`); }

 return RemoveTailsExpAmount.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return RemoveTailsExpAmount.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isTypusUserRegistry(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::user::TypusUserRegistry`; }
...
export class TypusUserRegistry implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::user::TypusUserRegistry`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = TypusUserRegistry.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::user::TypusUserRegistry`; readonly $typeArgs: []; readonly $isPhantom = TypusUserRegistry.$isPhantom;

 readonly id: ToField<UID>; readonly metadata: ToField<LinkedTable<"address", ToPhantom<Metadata>>>

 private constructor(typeArgs: [], fields: TypusUserRegistryFields, ) { this.$fullTypeName = composeSuiType( TypusUserRegistry.$typeName, ...typeArgs ) as `${typeof PKG_V1}::user::TypusUserRegistry`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.metadata = fields.metadata; }

 static reified( ): TypusUserRegistryReified { return { typeName: TypusUserRegistry.$typeName, fullTypeName: composeSuiType( TypusUserRegistry.$typeName, ...[] ) as `${typeof PKG_V1}::user::TypusUserRegistry`, typeArgs: [ ] as [], isPhantom: TypusUserRegistry.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => TypusUserRegistry.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TypusUserRegistry.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => TypusUserRegistry.fromBcs( data, ), bcs: TypusUserRegistry.bcs, fromJSONField: (field: any) => TypusUserRegistry.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => TypusUserRegistry.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => TypusUserRegistry.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => TypusUserRegistry.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => TypusUserRegistry.fetch( client, id, ), new: ( fields: TypusUserRegistryFields, ) => { return new TypusUserRegistry( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): TypusUserRegistry { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTypusUserRegistry(data.bcs.type)) { throw new Error(`object at is not a TypusUserRegistry object`); }

 return TypusUserRegistry.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return TypusUserRegistry.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
