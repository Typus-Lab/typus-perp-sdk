...
export const ProfitVault = new MoveStruct({ name: `${$moduleName}::ProfitVault`, fields: {
        id: object.UID,
        whitelist: vec_set.VecSet(bcs.Address),
        user_profits: table.Table,
        unlock_countdown_ts_ms: bcs.u64()
    } });
export const LockVault = new MoveStruct({ name: `${$moduleName}::LockVault`, fields: {
        id: object.UID,
        user_profits: table.Table
    } });
export const UserProfit = new MoveStruct({ name: `${$moduleName}::UserProfit`, fields: {
...
export const LockedUserProfit = new MoveStruct({ name: `${$moduleName}::LockedUserProfit`, fields: {
        user_profit: UserProfit,
        create_ts_ms: bcs.u64()
    } });
export const CreateProfitVaultEvent = new MoveStruct({ name: `${$moduleName}::CreateProfitVaultEvent`, fields: {
        unlock_countdown_ts_ms: bcs.u64()
    } });
export const AddWhitelistEvent = new MoveStruct({ name: `${$moduleName}::AddWhitelistEvent`, fields: {
        new_whitelist_address: bcs.Address
    } });
export const RemoveWhitelistEvent = new MoveStruct({ name: `${$moduleName}::RemoveWhitelistEvent`, fields: {
...
export const LockUserProfitEvent = new MoveStruct({ name: `${$moduleName}::LockUserProfitEvent`, fields: {
        user: bcs.Address,
        user_profit: UserProfit
    } });
export const UnlockUserProfitEvent = new MoveStruct({ name: `${$moduleName}::UnlockUserProfitEvent`, fields: {
        user: bcs.Address,
        user_profit: UserProfit
    } });
export const PutUserProfitEvent = new MoveStruct({ name: `${$moduleName}::PutUserProfitEvent`, fields: {
        user: bcs.Address,
        user_profit: UserProfit
    } });
export const WithdrawProfitEvent = new MoveStruct({ name: `${$moduleName}::WithdrawProfitEvent`, fields: {
...
export interface LockUserProfitOptions {
    package?: string;
    arguments: LockUserProfitArguments | [
        version: RawTransactionArgument<string>,
        profitVault: RawTransactionArgument<string>,
        lockVault: RawTransactionArgument<string>,
        user: RawTransactionArgument<string>,
...
export interface UnlockUserProfitOptions {
    package?: string;
    arguments: UnlockUserProfitArguments | [
        version: RawTransactionArgument<string>,
        profitVault: RawTransactionArgument<string>,
        lockVault: RawTransactionArgument<string>,
        user: RawTransactionArgument<string>,
...
export interface PutUserProfitOptions {
    package?: string;
    arguments: PutUserProfitArguments | [
        profitVault: RawTransactionArgument<string>,
        user: RawTransactionArgument<string>,
        balance: RawTransactionArgument<string>,
        baseTokenType: RawTransactionArgument<string>,
