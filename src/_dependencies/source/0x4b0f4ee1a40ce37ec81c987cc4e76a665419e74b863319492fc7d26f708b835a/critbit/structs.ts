...
export function isCritbitTree(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V1}::critbit::CritbitTree` + '<'); }
...
export class CritbitTree<V extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::critbit::CritbitTree`; static readonly $numTypeParams = 1; static readonly $isPhantom = [false,] as const;

 readonly $typeName = CritbitTree.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::critbit::CritbitTree<${ToTypeStr<V>}>`; readonly $typeArgs: [ToTypeStr<V>]; readonly $isPhantom = CritbitTree.$isPhantom;
 ...
 private constructor(typeArgs: [ToTypeStr<V>], fields: CritbitTreeFields<V>, ) { this.$fullTypeName = composeSuiType( CritbitTree.$typeName, ...typeArgs ) as `${typeof PKG_V1}::critbit::CritbitTree<${ToTypeStr<V>}>`; this.$typeArgs = typeArgs;
...
export function isInternalNode(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::critbit::InternalNode`; }
...
export class InternalNode implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::critbit::InternalNode`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = InternalNode.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::critbit::InternalNode`; readonly $typeArgs: []; readonly $isPhantom = InternalNode.$isPhantom;

 readonly mask: ToField<"u64">; readonly leftChild: ToField<"u64">; readonly rightChild: ToField<"u64">; readonly parent: ToField<"u64">

 private constructor(typeArgs: [], fields: InternalNodeFields, ) { this.$fullTypeName = composeSuiType( InternalNode.$typeName, ...typeArgs ) as `${typeof PKG_V1}::critbit::InternalNode`; this.$typeArgs = typeArgs;

 this.mask = fields.mask;; this.leftChild = fields.leftChild;; this.rightChild = fields.rightChild;; this.parent = fields.parent; }

 static reified( ): InternalNodeReified { return { typeName: InternalNode.$typeName, fullTypeName: composeSuiType( InternalNode.$typeName, ...[] ) as `${typeof PKG_V1}::critbit::InternalNode`, typeArgs: [ ] as [], isPhantom: InternalNode.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => InternalNode.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => InternalNode.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => InternalNode.fromBcs( data, ), bcs: InternalNode.bcs, fromJSONField: (field: any) => InternalNode.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => InternalNode.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => InternalNode.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => InternalNode.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => InternalNode.fetch( client, id, ), new: ( fields: InternalNodeFields, ) => { return new InternalNode( [], fields ) }, kind: "StructClassReified", } }
...
export function isLeaf(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V1}::critbit::Leaf` + '<'); }
